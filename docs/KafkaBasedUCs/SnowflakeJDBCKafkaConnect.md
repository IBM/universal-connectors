...
| **Credential**                                | The credential to authenticate with the datasource. Create the credential in **Credential Management**, or click **➕** to create a new one |The credential to authenticate with the datasource. Create the credential in **Credential Management**, or click **➕** to create a new one |  Note: When using the KeyPair Authentication. use the below Connection string.    # jdbc_connection_string => "jdbc:snowflake://<id>.<region>.<provider>.snowflakecomputing.com/?user=<snowflake_username>&warehouse=<warehouse_name>&db=<database_name>&schema=<database_schema>&private_key_file=${THIRD_PARTY_PATH}/<private_key_file_name>.p8&authenticator=snowflake_jwt"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| **Connection String**                         | Connection string to connect to Snowflake database                                                                                         | jdbc:snowflake://<hostname>/?user=<UserName>>&warehouse=<Warehouse>&db=<DB Name>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                                                                       |
                                                                                                    | **Initial time (ms)**                         | Initial polling time for audit logs                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
                                                                                                                                                                                                       | **Delay interval(ms)**                         | Delay interval polling time for audit logs                                                                                      |  Limitation: Snowflake's ACCOUNT_USAGE views have an inherent data latency of 45 minutes to 2 hours — events are not immediately visible after they occur. To ensure capture data, default value is 2 hours                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

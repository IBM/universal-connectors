...
* **Supported Guardium versions:**
   ...
   * The existing AWS MSSQL Kafka Connect profile README lists Guardium Data Protection appliance bundle 12.2.2 or
     later for that specific JDBC Kafka Connect plug-in.
...
- The universal connector can be installed on multiple Managed Units (MUs) for high availability, but all traffic will
  be displayed to a single MU.
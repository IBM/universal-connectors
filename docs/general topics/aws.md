...
7. In the log group, locate the <account id>CloudTrail\_<region> file. All events are logged to this file.
...
**_Note: Save the Access key ID and Secret access key and use them when you configure a log source in Universal Connector._**

**_Note: You can view the Secret access key only after it is created._**
...
**_Note: If that role does not exist, create it and assign it to the EC2 instance._**

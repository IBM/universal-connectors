...
**_Note: the output plug-in is presented here as an internal component of the universal connector pipeline and is not to be accessed or modified by the user._**
...
**_Please note: limitations associated with specific datasources are described in the universal connector plug-in readme files for each datasource. See [Available Plug-ins](/docs/available_plugins.md) for more information._**

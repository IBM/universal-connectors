Pre-packaged plugins can be downloaded from here: https://github.com/IBM/univer***REMOVED***l-connectors/releases
...
| [MSSQL](../filter-plugin/logstash-filter-mssql-guardium/MssqlOverJdbcPackage/README.md) | 14.0.x | AWS, On-prem, Azure, Google Cloud | IBM | CloudWatch (pull), JDBC (pull)   | **Guardium Data Protection only**.<br />Installs required [json_encode](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.3-plugins-filters-json_encode.html) filter plug-in. |

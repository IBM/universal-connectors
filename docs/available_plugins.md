...
| [MySQL](../filter-plugin/logstash-filter-mysql-guardium/README.md)        | 5.x, 8.0             | On-premise / Iaas, Google Cloud        | IBM                  | Syslog (push), Filebeat (push), Pub/Sub (pull) |         Google Cloud: **Guardium Data Protection only**. Tested with MySQL 8.0.                      |

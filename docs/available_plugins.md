...
| [Oracle Unified Audit](../filter-plugin/logstash-filter-oua-guardium/README.md) | 18, 19     | On-prem, Amazon RDS| IBM | Oracle Unified Audit (pull) | **Guardium Data Protection only** |

...
3. Click Upload File and select the offline [logstash-filter-singlestoredb_guardium_filter.zip](logstash-filter-singlestore-guardium/SingleStoreOverFilebeatPackage) plug-in. After it is uploaded, click OK.

...
**Note**: For Guardium Data Protection version 11.4 without appliance bundle 11.0p490 or prior or Guardium Data Protection version 11.5 without appliance bundle 11.0p540 or prior, download the [logstash-filter-apache_solr_azure_connector.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-apache_solr_azure_connector.zip) plug-in. (Do not unzip the offline-package file throughout the procedure).

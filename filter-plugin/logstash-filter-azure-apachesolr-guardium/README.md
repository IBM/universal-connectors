...
3. Click Upload File and select the offline **logstash-filter-apache_solr_azure_connector.zip** plug-in. After it is uploaded, click OK. This step is not necessary for Guardium Data Protection v11.0p490 or later, v11.0p540 or later, v12.0 or later.

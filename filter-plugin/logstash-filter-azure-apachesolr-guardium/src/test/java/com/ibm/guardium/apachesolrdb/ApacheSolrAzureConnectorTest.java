...
public class ApacheSolrAzureConnectorTest {
	...
	public void parseQtpRecordTestPost2() {
		final String qtp = "2022-02-08 07:30:09.930 INFO  (qtp2005169944-26) [c:techproducts s:shard2 r:core_node8 x:techproducts_shard2_replica_n6] o.a.s.u.p.LogUpdateProcessorFactory [techproducts_shard2_replica_n6]  webapp=/solr path=/update params={}{add=[adata, apple, asus, ati, belkin, canon, corsair, dell, maxtor, samsung, ... (11 adds)]} 0 30";
	...
	public void parseQtpCreateCoreTest() {
		...
		final String qtp = "2022-03-24 11:56:22.486 INFO  (qtp2005169944-57) [   ] o.a.s.s.HttpSolrCall [admin] webapp=null path=/admin/cores params={name=Solr_sample_core&action=CREATE&instanceDir=Solr_sample_core&wt=json} status=0 QTime=2167";
	...
	public void parseQtpUpdateCoreTest() {
		...
		final String qtp = "2022-03-25 12:25:26.240 INFO  (qtp2005169944-56) [   ] o.a.s.s.HttpSolrCall [admin] webapp=null path=/admin/cores params={core=Solr_sample_core&other=Sample&action=RENAME} status=0 QTime=237";
	...
	public void parseQtpDeleteCoreTest() {
		...
		final String qtp = "2022-03-25 04:49:23.148 INFO  (qtp2005169944-48) [   ] o.a.s.s.HttpSolrCall [admin] webapp=null path=/admin/cores params={deleteInstanceDir=true&core=Solr_sample_core&deleteDataDir=true&action=UNLOAD&wt=json&deleteIndex=true} status=0 QTime=690";

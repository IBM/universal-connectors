...
public class ApplicationConstantTest {
	...
	public static final String QUERYSTRING_CORECREATE_VALUE = "{name=Solr_sample_core&action=CREATE&instanceDir=Solr_sample_core&wt=json}";
	public static final String QUERYSTRING_COREUPDATE_VALUE = "{core=Solr_sample_core&other=Sample&action=RENAME}";
	public static final String QUERYSTRING_COREDELETE_VALUE = "{deleteInstanceDir=true&core=Solr_sample_core&deleteDataDir=true&action=UNLOAD&wt=json&deleteIndex=true}";
	...
	public static final String QUERYSTRING_SHARD_ADD_VALUE = "{}{add=[adata, apple, asus, ati, belkin, canon, corsair, dell, maxtor, samsung, ... (11 adds)]}";
	...
	public static final String COLLECTION_ERRORMSG_VALUE = "o.a.s.c.a.c.OverseerCollectionMessageHandler Collection: renamedTest3 operation: delete failed => org.apache.solr.common.SolrException: Collection : renamedTest3 is part of aliases: [Test3], remove or modify the aliases before removing this collection.";

...
public class ParserTest {
	...
	public void testParseAccessor() {
		...
		assertNotNull(record.getAccessor());
		assertEquals("my-gcp-project:my-gcp-project-3b9f0", actual.getServiceName());
		assertEquals("my-gcp-project_firebasedatabase.googleapis.com", actual.getServerHostName());

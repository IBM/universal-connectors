 ...
 //ListExports
    ...
    public void testParseRecord_ListExports() throws ParseException {
        final String dynamoString = "{\"eventVersion\": \"1.08\",\n" +
                ...
                "        \"arn\": \"arn:aws:iam::testAccountId:user/user@example.com\",\n" +

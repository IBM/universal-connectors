...
public class ParserTest {
    ...
    public void testParseRecord_Error() throws ParseException {
        final String dynamoString = "{ \"eventVersion\": \"1.08\", \"userIdentity\": { \"type\": \"IAMUser\", \"principalId\": \"<dummy_principal_id>\", \"arn\": \"arn:aws:iam::123456789012:user/rasika.shete\", \"accountId\": \"123456789012\", \"accessKeyId\": \"<dummy_access_key_id>\", \"userName\": \"rasika.shete\" }, \"eventTime\": \"2021-01-11T18:03:56Z\", \"eventSource\": \"dynamodb.amazonaws.com\", \"eventName\": \"UpdateTable\", \"awsRegion\": \"ap-south-1\", \"sourceIPAddress\": \"103.62.16.216\", \"userAgent\": \"aws-cli/2.1.15 Python/3.7.9 Windows/10 exe/AMD64 prompt/off command/dynamodb.update-table\", \"errorCode\": \"ResourceNotFoundException\", \"errorMessage\": \"Requested resource not found: Table: Music12 not found\", \"requestParameters\": { \"tableName\": \"Music12\", \"provisionedThroughput\": {  \"readCapacityUnits\": 20,  \"writeCapacityUnits\": 10 } }, \"responseElements\": null, \"requestID\": \"LBQJMQUKQNU73MVN8GHAGNBDDNVV4KQNSO5AEMVJF66Q9ASUAAJG\", \"eventID\": \"e1325551-1a43-453d-a188-5f91ba136c6a\", \"readOnly\": false, \"resources\": [ {  \"accountId\": \"123456789012\",  \"type\": \"AWS::DynamoDB::Table\",  \"ARN\": \"arn:aws:dynamodb:ap-south-1:123456789012:table/Music12\" } ], \"eventType\": \"AwsApiCall\", \"apiVersion\": \"2012-08-10\", \"managementEvent\": true, \"recipientAccountId\": \"123456789012\", \"eventCategory\": \"Management\"}";
        final JsonObject dynamoJson = JsonParser.parseString(dynamoString).getAsJsonObject();
    ...
    public void testParseAsConstruct_deleteTable() {
        final String dynamoString = "{\"eventVersion\": \"1.08\", \"userIdentity\": { \"type\": \"IAMUser\", \"principalId\": \"<dummy_principal_id>\", \"arn\": \"arn:aws:iam::123456789012:user/rasika.shete\", \"accountId\": \"123456789012\", \"accessKeyId\": \"<dummy_access_key_id>\", \"userName\": \"rasika.shete\", \"sessionContext\": {   \"attributes\": {   \"creationDate\": \"2020-12-28T06:58:12Z\",   \"mfaAuthenticated\": \"false\"   } } }, \"eventTime\": \"2020-12-28T08:18:45Z\", \"eventSource\": \"dynamodb.amazonaws.com\", \"eventName\": \"DeleteTable\", \"awsRegion\": \"ap-south-1\", \"sourceIPAddress\": \"103.62.17.201\", \"userAgent\": \"console.amazonaws.com\", \"requestParameters\": { \"tableName\": \"Students\" }, \"responseElements\": { \"tableDescription\": {   \"tableId\": \"97916744-b891-4756-a966-ca73720eaa73\",   \"provisionedThroughput\": {   \"readCapacityUnits\": 5,   \"writeCapacityUnits\": 5,   \"numberOfDecreasesToday\": 0   },   \"tableName\": \"Students\",   \"tableSizeBytes\": 0,   \"tableStatus\": \"DELETING\",   \"tableArn\": \"arn:aws:dynamodb:ap-south-1:123456789012:table/Students\",   \"itemCount\": 0 } }, \"requestID\": \"QKK5BIUO639AHVDAR1NIFO2UJ3VV4KQNSO5AEMVJF66Q9ASUAAJG\", \"eventID\": \"420dc42a-369a-46f4-b9ea-d7b8867bd86b\", \"readOnly\": false, \"resources\": [ {   \"accountId\": \"123456789012\",   \"type\": \"AWS::DynamoDB::Table\",   \"ARN\": \"arn:aws:dynamodb:ap-south-1:123456789012:table/Students\" } ], \"eventType\": \"AwsApiCall\", \"apiVersion\": \"2012-08-10\", \"managementEvent\": true, \"recipientAccountId\": \"123456789012\", \"eventCategory\": \"Management\"}";
        final JsonObject dynamoJson = JsonParser.parseString(dynamoString).getAsJsonObject();
        final Construct result = Parser.parseAsConstruct(dynamoJson);
    ...
    public void testParseRecord_LoginFailed() throws ParseException {
        final String dynamoString = "{\"eventVersion\":\"1.08\",\"userIdentity\":{\"type\":\"IAMUser\",\"principalId\":\"AIDAVBQDAZ24X5HC7KJQ7\",\"arn\":\"arn:aws:iam::123456789012:user\\/uc-no-dynamodb-access\",\"accountId\":\"123456789012\",\"accessKeyId\":\"AKIAIOSFODNN7EXAMPLE\",\"userName\":\"uc-no-dynamodb-access\"},\"eventTime\":\"2023-06-26T11:17:15Z\",\"eventSource\":\"dynamodb.amazonaws.com\",\"eventName\":\"ListTables\",\"awsRegion\":\"us-east-1\",\"sourceIPAddress\":\"103.161.98.19\",\"userAgent\":\"aws-cli\\/2.11.3 Python\\/3.11.2 Darwin\\/22.4.0 exe\\/x86_64 prompt\\/off command\\/dynamodb.list-tables\",\"errorCode\":\"AccessDenied\",\"errorMessage\":\"User: arn:aws:iam::123456789012:user\\/uc-no-dynamodb-access is not authorized to perform: dynamodb:ListTables on resource: arn:aws:dynamodb:us-east-1:123456789012:table\\/* because no identity-based policy allows the dynamodb:ListTables action\",\"requestParameters\":null,\"responseElements\":null,\"requestID\":\"4VO62N9BI88GUKMINUSTNET1G3VV4KQNSO5AEMVJF66Q9ASUAAJG\",\"eventID\":\"f8a32cc9-579e-4f60-874a-62bbe8b4ac3e\",\"readOnly\":true,\"eventType\":\"AwsApiCall\",\"managementEvent\":true,\"recipientAccountId\":\"123456789012\",\"eventCategory\":\"Management\",\"tlsDetails\":{\"tlsVersion\":\"TLSv1.2\",\"cipherSuite\":\"ECDHE-RSA-AES128-GCM-SHA256\",\"clientProvidedHostHeader\":\"dynamodb.us-east-1.amazonaws.com\"}}";
        final JsonObject dynamoJson = JsonParser.parseString(dynamoString).getAsJsonObject();

...
public class ParserTest {
    ...
    public void testParseAccessor() throws ParseException {
        ...
        Assert.assertEquals("222222222222:root", actual.getDbUser());

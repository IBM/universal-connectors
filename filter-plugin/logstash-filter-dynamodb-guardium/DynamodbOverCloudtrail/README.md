...
6. Log files will be displayed as .json.gz files.
7. The log file can be then opened in the browser in readable format or downloaded as per the requirement.

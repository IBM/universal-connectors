...
public class Parser {
	...
	public static String decodeContent(String obj) {
        try {
            ...
            logger.error("Exception occured while decoding query: " + e.getMes***REMOVED***ge());
        }
        return obj;
    }
	/**
	...
	private static String parseCollectionId(String collectionId) {
		...
		// projects/my-gcp-project/databases/(default)/documents/1-june-collection/doc/coll2/doc2/coll3/doc3/coll4/doc4

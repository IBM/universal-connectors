...
public class ParserTest {
	...
	public void testParseAccessor() throws Exception {
		...
		assertNotNull(record.getAccessor());
		assertEquals("my-gcp-project-(default)", actual.getServiceName());
		assertEquals("my-gcp-project_firestore.googleapis.com", actual.getServerHostName());

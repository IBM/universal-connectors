...
- When the universal collector starts to collect data, it may show two S-TAP statuses in the pattern "postgres*<server-host-name>" and "cassandra*<server-host-name>" based on the types of logs it collects..

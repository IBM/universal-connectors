...
module Rake
  ...
  class Application
    ...
    def standard_exception_handling # :nodoc:
      ...
      $stderr.puts ex.mes***REMOVED***ge
      exit(false)
    rescue Exception => ex
      # Exit with error mes***REMOVED***ge
      display_error_mes***REMOVED***ge(ex)
    ...
    # Display the error mes***REMOVED***ge that caused the exception.
    def display_error_mes***REMOVED***ge(ex) # :nodoc:
      trace "#{name} aborted!"
    ...
    def display_exception_details(ex) # :nodoc:
      ...
      display_exception_mes***REMOVED***ge_details(ex)
    ...
    def display_exception_mes***REMOVED***ge_details(ex) # :nodoc:
      if ex.instance_of?(RuntimeError)
        trace ex.mes***REMOVED***ge
      else
        trace "#{ex.class.name}: #{ex.mes***REMOVED***ge}"
      end
    end
    ...
    # Warn about deprecated u***REMOVED***ge.
    #
    # Example:
    #    Rake.application.deprecate("import", "Rake.import", caller.first)
    #
    def deprecate(old_u***REMOVED***ge, new_u***REMOVED***ge, call_site) # :nodoc:
      unless options.ignore_deprecate
        $stderr.puts "WARNING: '#{old_u***REMOVED***ge}' is deprecated.  " +
          "Please use '#{new_u***REMOVED***ge}' instead.\n" +
          "    at #{call_site}"
      end
    end
    ...
    def standard_rake_options # :nodoc:
      sort_options(
        [
          ...
          ["--quiet", "-q",
            "Do not log mes***REMOVED***ges to standard output.",
          ...
          ["--verbose", "-v",
            "Log mes***REMOVED***ge to standard output.",
          ...
          ["--no-deprecation-warnings", "-X",
            "Di***REMOVED***ble the deprecation warnings.",
            lambda { |value|
    ...
    def handle_options(argv) # :nodoc:
      ...
      OptionParser.new do |opts|
        ...
        opts.on_tail("-h", "--help", "-H", "Display this help mes***REMOVED***ge.") do
          puts opts
          exit
        end

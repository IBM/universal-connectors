...
would even be interested in it.  All I can ***REMOVED***y is that Why's onion truck
...
but during the course of the conver***REMOVED***tion I began lamenting some of the
...
could just use Ruby inside a Makefile" I ***REMOVED***id.
...
Ok, now I was really hooked.  Last night (during CSI!) I mas***REMOVED***ged the
...
Get it?  Ruby-Make. Rake!"  He ***REMOVED***id he envisioned the tasks as leaves
...
mes***REMOVED***ge).  Does this sound interesting to anyone?  If so, I'll continue
...
So ... Sorry for the long rambling mes***REMOVED***ge.  Like I ***REMOVED***id, I never

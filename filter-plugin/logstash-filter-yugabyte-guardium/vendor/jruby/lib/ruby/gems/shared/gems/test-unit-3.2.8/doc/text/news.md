...
### Fixes
  ...
  * Fixed a typo.
    [GitHub#156][Patch by ma***REMOVED*** kunikata]
...
### Fixes
  ...
  * Fixed assertion mes***REMOVED***ge in English.
...
### Fixes
  ...
  * Fixed a bug that `--location=LINE` may not detect a test when
    ...
    [Reported by Ryota Sa***REMOVED***be]
...
### Fixes
  ...
  * Fixed a bug that test isn't ran. The test has the ***REMOVED***me name as
...
### Improvements
  ...
  * Updated ***REMOVED***mple code. [GitHub#109][Patch by takiy33]
...
### Fixes
  ...
  * `--location`: Fixed a bug that `--location LINE` doesn't work when
    test script is specified as relative path. [Reported by TOMITA Ma***REMOVED***hiro]
...
### Fixes
  ...
  * Fixed a homepage URL RubyGems spec.
    [GitHub#96][Patch by Ma***REMOVED***yoshi Takahashi]
  ...
  * Fixed typos in documents.
    ...
    [GitHub#102][GitHub#103][Patch by Ma***REMOVED***fumi Yokoyama]
  * Fixed a bug that the ***REMOVED***me name test isn't executed in sub test case.
    [GitHub#104][Reported by wanabe]

### Thanks

  * Daniel Berger
  * Ma***REMOVED***yoshi Takahashi
  * jeremiahishere
  * scivola
  * Ma***REMOVED***fumi Yokoyama
  * wanabe
...
### Improvements
  ...
  * Added description about "/PATTERN/" style value in auto runner u***REMOVED***ge.
...
### Fixes
  ...
  * Fixed a bug that teardown blocks aren't called with sub class to
    parent class order.
    [GitHub#85][Reported by TOMITA Ma***REMOVED***hiro]
...
### Improvements
  ...
  * Improved `Test::Unit::TestCase.test` performance.
    100 times faster.
  * Supported `Proc` for user mes***REMOVED***ge.
    [Sugested by Nobuyoshi Nakada]

### Fixes

  * Fixed markup in document.
    [GitHub#81][Patch by Ma***REMOVED***fumi Yokoyama]
...
### Improvements
  ...
  * [UI][console]: Accepted no mes***REMOVED***ge failure.
...
### Improvements
  ...
  * Supported Ruby 2.0.0. [GitHub#54] [Reported by mta***REMOVED***ka]
...
### Improvements
  ...
  * [ui][console] Improved multiline falut mes***REMOVED***ge display.
...
### Improvements
  ...
  * Supported showing ASCII-8BIT diff in failure mes***REMOVED***ge.
...
It's a failure mes***REMOVED***ge readability improvement release.
...
### Improvements
  ...
  * [ui][console] Added markers betwen a failure detail
    mes***REMOVED***ge in progress to improve visibility.
...
### Improvements
  ...
  * Accepted AssertionMes***REMOVED***ge as assertion's user mes***REMOVED***ge.
...
* 22 enhancements
  ...
  * validate mes***REMOVED***ge value for assert.
...
* 5 major enchancements
  ...
  * [#28181] improve assert_in_delta mes***REMOVED***ge.
    [Suggested by David MARCHALAND]
  * show string encoding in assert_equal failure mes***REMOVED***ge if
    they are different.
...
* 4 minor enhancements
  ...
  * TC_ -> Test in ***REMOVED***mple test case name.
...
* 19 major enhancements
  ...
  * add assert_raise_mes***REMOVED***ge. [#20851] [Designing Patterns]
  * support folded diff.

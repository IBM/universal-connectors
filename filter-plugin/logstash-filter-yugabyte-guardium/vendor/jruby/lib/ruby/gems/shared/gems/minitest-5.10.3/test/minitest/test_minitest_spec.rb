...
describe Minitest::Spec do
  ...
  it "needs to verify binary mes***REMOVED***ges" do
  ...
  it "needs to verify identity" do
    1.must_be_***REMOVED***me_as(1).must_equal true

    assert_triggered "Expected 1 (oid=N) to be the ***REMOVED***me as 2 (oid=N)." do
      1.must_be_***REMOVED***me_as 2
    end

    assert_triggered "msg.\nExpected 1 (oid=N) to be the ***REMOVED***me as 2 (oid=N)." do
      1.must_be_***REMOVED***me_as 2, "msg"
    end
  end
  ...
  it "needs to verify non-identity" do
    1.wont_be_***REMOVED***me_as(2).must_equal false

    assert_triggered "Expected 1 (oid=N) to not be the ***REMOVED***me as 1 (oid=N)." do
      1.wont_be_***REMOVED***me_as 1
    end

    assert_triggered "msg.\nExpected 1 (oid=N) to not be the ***REMOVED***me as 1 (oid=N)." do
      1.wont_be_***REMOVED***me_as 1, "msg"
    end
  end
  ...
  it "needs to verify objects not responding to a mes***REMOVED***ge" do
  ...
  it "needs to verify using any (negative) predicate" do
    @assertion_count -= 1 # doesn"t take a mes***REMOVED***ge
...
describe Minitest::Spec, :let do
  ...
  it "raises an error if the name shadows a normal instance method" do
    proc { self.class.let(:mes***REMOVED***ge) { true } }.must_raise ArgumentError
  end
...
class TestSpecInTestCase < MetaMetaMetaTestCase
  ...
  def test_expectation_with_a_mes***REMOVED***ge

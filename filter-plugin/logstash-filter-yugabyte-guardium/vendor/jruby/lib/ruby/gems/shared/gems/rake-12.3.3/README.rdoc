...
* {Rake command-line}[link:doc/command_line_u***REMOVED***ge.rdoc]
* {Writing Rakefiles}[link:doc/rakefile.rdoc]
* The original {Rake announcement}[link:doc/rational.rdoc]
* Rake {glos***REMOVED***ry}[link:doc/glos***REMOVED***ry.rdoc]
...
[<b>Ryan Dlugosz</b>] For the initial conver***REMOVED***tion that sparked Rake.

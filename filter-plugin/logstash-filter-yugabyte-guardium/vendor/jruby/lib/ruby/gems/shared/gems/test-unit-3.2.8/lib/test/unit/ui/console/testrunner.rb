    ...
    module UI
      module Console
        ...
        class TestRunner < UI::TestRunner
          ...
          def output_fault_in_detail(fault)
            if fault.is_a?(Failure) and
              ...
              if @reverse_output
                ...
                output_failure_mes***REMOVED***ge(fault)
              ...
              if @reverse_output
                ...
                output_fault_mes***REMOVED***ge(fault)
              else
                output_single("#{fault.label}: ")
                output_single(fault.test_name, fault_color(fault))
                output_fault_mes***REMOVED***ge(fault)
          ...
          def output_fault_mes***REMOVED***ge(fault)
            mes***REMOVED***ge = fault.mes***REMOVED***ge
            return if mes***REMOVED***ge.nil?

            if mes***REMOVED***ge.include?("\n")
              output(":")
              mes***REMOVED***ge.each_line do |line|
                output("  #{line.chomp}")
              end
            else
              output(": #{mes***REMOVED***ge}")
            end
          end
          ...
          def output_failure_mes***REMOVED***ge(failure)
            ...
            output(failure.user_mes***REMOVED***ge) if failure.user_mes***REMOVED***ge
            output_single("<")
          ...
          def output_fault_in_short(fault)
            if @reverse_output
              ...
              output_single("#{fault.label}: ")
              output_single(fault.mes***REMOVED***ge, fault_color(fault))

...
class TestMinitestUnit < MetaMetaMetaTestCase
  ...
  def test_infectious_binary_encoding
    @tu = Class.new Minitest::Test do
      ...
      def test_this_is_non_ascii_failure_mes***REMOVED***ge
    ...
    expected = clean <<-EOM
      ...
      Finished in 0.00
        ...
        1) Error:
      #<Class:0xXXX>#test_this_is_non_ascii_failure_mes***REMOVED***ge:
      RuntimeError: ЁЁЁ
          FILE:LINE:in `test_this_is_non_ascii_failure_mes***REMOVED***ge'
...
class TestMinitestUnitTestCase < Minitest::Test
  ...
  # which is not thread***REMOVED***fe. Nearly every method in here is an
  ...
  def test_assert__triggered_mes***REMOVED***ge
  ...
  def test_assert_equal_different_long_msg
    ...
    assert_triggered msg do
      o1 = "haha" * 10
      o2 = "blah" * 10
      @tc.assert_equal o1, o2, "mes***REMOVED***ge"
    end
  end
  ...
  def test_assert_equal_different_short_msg
    assert_triggered util_msg(1, 2, "mes***REMOVED***ge") do
      @tc.assert_equal 1, 2, "mes***REMOVED***ge"
    end
  end
  ...
  def test_assert_includes_triggered
    ...
    assert_equal expected, e.mes***REMOVED***ge
  end
  ...
  def test_assert_raises_default_triggered
    ...
    actual = e.mes***REMOVED***ge.gsub(/^.+:\d+/, "FILE:LINE")
  ...
  def test_assert_raises_subclass_triggered
    e = assert_raises Minitest::Assertion do
      @tc.assert_raises SomeError do
        raise AnError, "some mes***REMOVED***ge"
      end
    end
    ...
    expected = clean <<-EOM
      ...
      Class: <AnError>
      Mes***REMOVED***ge: <\"some mes***REMOVED***ge\">
      ---Backtrace---
  ...
  def test_assert_***REMOVED***me
    ...
    o = "blah"
    @tc.assert_***REMOVED***me 1, 1
    @tc.assert_***REMOVED***me :blah, :blah
    @tc.assert_***REMOVED***me o, o
  end

  def test_assert_***REMOVED***me_triggered
    @assertion_count = 2

    assert_triggered "Expected 2 (oid=N) to be the ***REMOVED***me as 1 (oid=N)." do
      @tc.assert_***REMOVED***me 1, 2
    end

    s1 = "blah"
    s2 = "blah"

    assert_triggered 'Expected "blah" (oid=N) to be the ***REMOVED***me as "blah" (oid=N).' do
      @tc.assert_***REMOVED***me s1, s2
    end
  end
  ...
  def test_class_asserts_match_refutes
    ...
    ignores += %w[assert_no_match assert_not_equal assert_not_nil
                  assert_not_***REMOVED***me assert_nothing_raised
  ...
  def test_mes***REMOVED***ge
    ...
    assert_equal "blah2.",         @tc.mes***REMOVED***ge          { "blah2" }.call
    assert_equal "blah2.",         @tc.mes***REMOVED***ge("")      { "blah2" }.call
    assert_equal "blah1.\nblah2.", @tc.mes***REMOVED***ge(:blah1)  { "blah2" }.call
    assert_equal "blah1.\nblah2.", @tc.mes***REMOVED***ge("blah1") { "blah2" }.call

    mes***REMOVED***ge = proc { "blah1" }
    assert_equal "blah1.\nblah2.", @tc.mes***REMOVED***ge(mes***REMOVED***ge) { "blah2" }.call

    mes***REMOVED***ge = @tc.mes***REMOVED***ge { "blah1" }
    assert_equal "blah1.\nblah2.", @tc.mes***REMOVED***ge(mes***REMOVED***ge) { "blah2" }.call
  end

  def test_mes***REMOVED***ge_mes***REMOVED***ge
    assert_triggered "whoops.\nExpected: 1\n  Actual: 2" do
      @tc.assert_equal 1, 2, mes***REMOVED***ge { "whoops" }
    end
  end

  def test_mes***REMOVED***ge_lambda
    assert_triggered "whoops.\nExpected: 1\n  Actual: 2" do
      @tc.assert_equal 1, 2, lambda { "whoops" }
    end
  end

  def test_mes***REMOVED***ge_deferred
    @assertion_count, var = 0, nil

    msg = mes***REMOVED***ge { var = "blah" }
  ...
  def test_refute_***REMOVED***me
    @tc.refute_***REMOVED***me 1, 2
  end

  def test_refute_***REMOVED***me_triggered
    assert_triggered "Expected 1 (oid=N) to not be the ***REMOVED***me as 1 (oid=N)." do
      @tc.refute_***REMOVED***me 1, 1
    end
  end
  ...
  def test_runnable_methods_random
    ...
    ***REMOVED***mple_test_case = Class.new FakeNamedTest do
    ...
    assert_equal expected, ***REMOVED***mple_test_case.runnable_methods
  end
  ...
  def assert_triggered expected, klass = Minitest::Assertion
    ...
    msg = e.mes***REMOVED***ge.sub(/(---Backtrace---).*/m, '\1')

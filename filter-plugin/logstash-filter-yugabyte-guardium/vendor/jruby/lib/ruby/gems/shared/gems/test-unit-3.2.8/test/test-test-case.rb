    ...
    class TestTestCase < TestCase
      ...
      def test_add_error
        ...
        assert_equal([
                       {
                         :class     => Error,
                         :mes***REMOVED***ge   => "ZeroDivisionError: divided by 0",
      ...
      private
      def check(mes***REMOVED***ge, passed)
        add_assertion
        raise AssertionFailedError.new(mes***REMOVED***ge) unless passed
      end

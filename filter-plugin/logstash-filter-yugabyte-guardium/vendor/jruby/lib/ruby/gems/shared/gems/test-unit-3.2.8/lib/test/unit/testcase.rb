  ...
  module Unit
    ...
    class TestCase
      ...
      class << self
        ...
        #
        # In declarative syntax u***REMOVED***ge, the following two
        # test definitions are the almost ***REMOVED***me:
        #
        ...
        #   end
        #
        # In test method mark u***REMOVED***ge, the "my_test_method" is
        ...
        def test(*test_description_or_targets, &block)
          if block_given?
            ...
            if n_arguments > 1
              mes***REMOVED***ge = "wrong number of arguments (#{n_arguments} for 1)"
              raise ArgumentError, mes***REMOVED***ge
            end

...
module Test
  module Unit
    ...
    module TestCaseOmissionSupport
      ...
      #     # Reached here
      #   end
      def omit(mes***REMOVED***ge=nil, &block)
        mes***REMOVED***ge ||= "omitted."
        if block_given?
          omission = Omission.new(name, filter_backtrace(caller), mes***REMOVED***ge,
                                  :method_name => @method_name)
          add_omission(omission)
        else
          raise OmittedError.new(mes***REMOVED***ge)
        end
      end

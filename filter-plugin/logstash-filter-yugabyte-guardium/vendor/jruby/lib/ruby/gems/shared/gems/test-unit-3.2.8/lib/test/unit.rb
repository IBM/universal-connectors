...
module Test # :nodoc:
  ...
  # 
  # Ma***REMOVED***ki Suketa, for his work on RubyUnit, which filled a vital need in
  ...
  # this down and see how Test::Unit provides each of these neces***REMOVED***ry
  # pieces.
  #
  #
  # == Assertions
  ...
  # fixture. If they're all bundled into the ***REMOVED***me test class, they can
  # all share the setting up and tearing down of that data, eliminating
  # unneces***REMOVED***ry duplication and making it much easier to add related
  # tests.
  #
  # Test::Unit::TestCase wraps up a collection of test methods together
  # and allows you to easily set up and tear down the ***REMOVED***me test fixture

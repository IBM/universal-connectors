...
module Test
  module Unit
    ...
    class Failure
      attr_reader :test_name, :location, :mes***REMOVED***ge
      attr_reader :method_name, :source_location
      attr_reader :expected, :actual, :user_mes***REMOVED***ge
      ...
      # mes***REMOVED***ge.
      def initialize(test_name, location, mes***REMOVED***ge, options={})
        @test_name = test_name
        @location = location
        @mes***REMOVED***ge = mes***REMOVED***ge
      ...
      def short_display
        "#@test_name: #{@mes***REMOVED***ge.split("\n")[0]}"
      end
      ...
      private
      def compute_diff
        Assertions::AssertionMes***REMOVED***ge.delayed_diff(@expected, @actual).inspect
      end
    end
    ...
    module FailureHandler
      ...
      #
      # @param mes***REMOVED***ge [String] The description about the failure.
      ...
      #   It is used for diff between expected and actual of the failure.
      # @option options [String] :user_mes***REMOVED***ge
      #   The mes***REMOVED***ge of the assertion from user.
      ...
      #   The location where the test is defined. It is the ***REMOVED***me
      #   format as Proc#source_location. That is, it's an array of
      #   path and and line number where the test definition is
      #   started.
      # @return [void]
      def add_failure(mes***REMOVED***ge, backtrace, options={})
        default_options = {
          :method_name => @method_name,
          :source_location => self[:source_location],
        }
        failure = Failure.new(name, filter_backtrace(backtrace), mes***REMOVED***ge,
      ...
      def handle_assertion_failed_error(exception)
        ...
        problem_occurred
        add_failure(exception.mes***REMOVED***ge, exception.backtrace,
                    :expected => exception.expected,
                    :actual => exception.actual,
                    :inspected_expected => exception.inspected_expected,
                    :inspected_actual => exception.inspected_actual,
                    :user_mes***REMOVED***ge => exception.user_mes***REMOVED***ge)
        true
      end
    end

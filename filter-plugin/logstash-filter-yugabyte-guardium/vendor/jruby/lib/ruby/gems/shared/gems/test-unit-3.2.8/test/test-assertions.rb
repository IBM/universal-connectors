...
module Test
  module Unit
    module AssertionCheckable
      ...
      private
      def check(value, mes***REMOVED***ge="")
        add_assertion
        raise AssertionFailedError.new(mes***REMOVED***ge) unless value
      end

      def check_assertions(expect_fail, options={})
        expected_mes***REMOVED***ge = options[:expected_mes***REMOVED***ge]
        actual_mes***REMOVED***ge_normalizer = options[:actual_mes***REMOVED***ge_normalizer]
        return_value_expected = options[:return_value_expected]
        @actual_assertion_count = 0
        failed = true
        actual_mes***REMOVED***ge = nil
        ...
        begin
          ...
          actual_mes***REMOVED***ge = error.mes***REMOVED***ge
        end
        @catch_assertions = false

        if expect_fail
          mes***REMOVED***ge = "Should have failed, but didn't"
        else
          mes***REMOVED***ge = "Should not have failed, but did with mes***REMOVED***ge\n" +
            "<#{actual_mes***REMOVED***ge}>"
        end
        check(expect_fail == failed, mes***REMOVED***ge)

        mes***REMOVED***ge = "Should have made one assertion but made\n" +
          "<#{@actual_assertion_count}>"
        check(1 == @actual_assertion_count, mes***REMOVED***ge)

        if expect_fail
          if actual_mes***REMOVED***ge_normalizer
            actual_mes***REMOVED***ge = actual_mes***REMOVED***ge_normalizer.call(actual_mes***REMOVED***ge)
          end
          case expected_mes***REMOVED***ge
          when String
            check(expected_mes***REMOVED***ge == actual_mes***REMOVED***ge,
                  "Should have the correct mes***REMOVED***ge.\n" +
                  "<#{expected_mes***REMOVED***ge.inspect}> expected but was\n" +
                  "<#{actual_mes***REMOVED***ge.inspect}>")
          when Regexp
            check(expected_mes***REMOVED***ge =~ actual_mes***REMOVED***ge,
                  "The mes***REMOVED***ge should match correctly.\n" +
                  "</#{expected_mes***REMOVED***ge.source}/> expected to match\n" +
                  "<#{actual_mes***REMOVED***ge.inspect}>")
          else
            check(false,
                  "Incorrect expected mes***REMOVED***ge type in assert_nothing_failed")
          end
        else
      ...
      def check_nothing_fails(return_value_expected=false, &proc)
        check_assertions(false,
                         {:expected_mes***REMOVED***ge => nil,
                          :return_value_expected => return_value_expected},
                         &proc)
      end

      def check_fail(expected_mes***REMOVED***ge, options={}, &proc)
        check_assertions(true,
                         options.merge(:expected_mes***REMOVED***ge => expected_mes***REMOVED***ge),
                         &proc)
      end

      def check_fail_exception(expected_mes***REMOVED***ge, options={}, &proc)
        normalizer = lambda do |actual_mes***REMOVED***ge|
          actual_mes***REMOVED***ge.gsub(/(^[^:\n]+:\d+:.+\n?)+\z/, "")
        end
        check_assertions(true,
                         options.merge(:expected_mes***REMOVED***ge => expected_mes***REMOVED***ge,
                                       :actual_mes***REMOVED***ge_normalizer => normalizer),
                         &proc)
      end
      ...
      def add_failure(mes***REMOVED***ge, location=caller, options=nil)
    ...
    class TestAssertions < TestCase
      ...
      class TestAssertBlock < self
        def test_pass_without_mes***REMOVED***ge
          check_nothing_fails {
            assert_block {true}
          }
        end

        def test_pass_with_mes***REMOVED***ge
          check_nothing_fails {
            assert_block("successful assert_block") {true}
          }
        end

        def test_failure_without_mes***REMOVED***ge
          check_fail("assert_block failed.") {
            assert_block {false}
          }
        end

        def test_failure_with_mes***REMOVED***ge
      ...
      class TestAssertEqual < self
        class TestSuccess < self
          def test_without_mes***REMOVED***ge
            check_nothing_fails {
              assert_equal("string1", "string1")
            }
          end

          def test_with_mes***REMOVED***ge
            check_nothing_fails {
...
EOM
          ...
          def test_with_mes***REMOVED***ge_proc
            mes***REMOVED***ge = <<-EOM.chomp
failed assert_equal.
<"string1"> expected but was
<"string2">.
...
?       ^
EOM
           check_fail(mes***REMOVED***ge) do
              assert_equal("string1", "string2", lambda {"failed assert_equal"})
            end
          end
        end

        class TestSystemMes***REMOVED***ge < self
...
EOM
          ...
          def test_***REMOVED***me_inspected_objects
            now = Time.now
...
EOM
          ...
          def test_multi_lines_result
            mes***REMOVED***ge = <<-EOM.chomp
<#{AssertionMes***REMOVED***ge.convert("a\nb")}> expected but was
<#{AssertionMes***REMOVED***ge.convert("x")}>.
...
<"must be failed">.
      ...
      def test_assert_raise_success
        ...
        check(return_value.mes***REMOVED***ge == "Error",
...
<RuntimeError(<Error>)>.
EOM
        check_fail_exception(mes***REMOVED***ge) do
...
EOM
        check_fail(mes***REMOVED***ge.chomp) do
...
EOM
      ...
      def test_assert_not_nil
        ...
        check_nothing_fails{assert_not_nil(false, "mes***REMOVED***ge")}
        check_fail("<nil> was expected to not be nil."){assert_not_nil(nil)}
        check_fail("mes***REMOVED***ge.\n<nil> was expected to not be nil.") {assert_not_nil(nil, "mes***REMOVED***ge")}
      end
      ...
      def test_assert_***REMOVED***me
        thing = "thing"
        check_nothing_fails {
          assert_***REMOVED***me(thing, thing)
        }
        check_nothing_fails {
          assert_***REMOVED***me(thing, thing, "successful assert_***REMOVED***me")
        }
        check_nothing_fails {
          assert_***REMOVED***me(thing, thing, "successful assert_***REMOVED***me")
        }
        ...
        check_fail(%Q{<"thing">\nwith id <#{thing.__id__}> was expected to be equal? to\n<"thing">\nwith id <#{thing2.__id__}>.}) {
          assert_***REMOVED***me(thing, thing2)
        }
        check_fail(%Q{failed assert_***REMOVED***me.\n<"thing">\nwith id <#{thing.__id__}> was expected to be equal? to\n<"thing">\nwith id <#{thing2.__id__}>.}) {
          assert_***REMOVED***me(thing, thing2, "failed assert_***REMOVED***me")
        }
      end
      ...
      def test_assert_nothing_raised
        ...
        expected_mes***REMOVED***ge =
          "<Object> must be a subclass of Exception, " +
          "an object of Exception subclasses or a Module."
        check_fail(expected_mes***REMOVED***ge) {
          assert_nothing_raised(Object) {
            1 + 1
          }
        }
        expected_mes***REMOVED***ge = <<-EOM.chomp
Exception raised:
RuntimeError(<Error>)
EOM
        check_fail_exception(expected_mes***REMOVED***ge) {
          assert_nothing_raised {
            raise "Error"
          }
        }
...
EOM
      ...
      def test_flunk
        ...
        check_fail("flunk mes***REMOVED***ge.") {
          flunk("flunk mes***REMOVED***ge")
        }
      end

      def test_assert_not_***REMOVED***me
        thing = "thing"
        thing2 = thing.dup
        check_nothing_fails {
          assert_not_***REMOVED***me(thing, thing2)
        }
        check_nothing_fails {
          assert_not_***REMOVED***me(thing, thing2, "mes***REMOVED***ge")
        }
        check_fail(%Q{<"thing">\nwith id <#{thing.__id__}> was expected to not be equal? to\n<"thing">\nwith id <#{thing.__id__}>.}) {
          assert_not_***REMOVED***me(thing, thing)
        }
        check_fail(%Q{mes***REMOVED***ge.\n<"thing">\nwith id <#{thing.__id__}> was expected to not be equal? to\n<"thing">\nwith id <#{thing.__id__}>.}) {
          assert_not_***REMOVED***me(thing, thing, "mes***REMOVED***ge")
        }
      end
      ...
      def test_assert_not_equal
        ...
        check_nothing_fails {
          assert_not_equal("string1", "string2", "mes***REMOVED***ge")
        }
        check_fail(%Q{<"string"> was expected to be != to\n<"string">.}) {
          assert_not_equal("string", "string")
        }
        check_fail(%Q{mes***REMOVED***ge.\n<"string"> was expected to be != to\n<"string">.}) {
          assert_not_equal("string", "string", "mes***REMOVED***ge")
        }
      end
      ...
      def test_assert_not_match_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_not_match(/sling/, "string", "mes***REMOVED***ge")
        end
      end
      ...
      def test_assert_not_match_fail_match_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    "</string/> was expected to not match\n" +
                    "<\"string\">.") do
          assert_not_match(/string/, "string", "mes***REMOVED***ge")
        end
      end

      def test_assert_no_match
        check_nothing_fails{assert_no_match(/sling/, "string")}
        check_nothing_fails{assert_no_match(/sling/, "string", "mes***REMOVED***ge")}
        ...
        check_fail(%Q{mes***REMOVED***ge.\n</string/> was expected to not match\n<"string">.}) do
          assert_no_match(/string/, "string", "mes***REMOVED***ge")
        end
      end

      def test_assert_throw
        check_nothing_fails do
          assert_throw(:thing, "mes***REMOVED***ge") do
            throw :thing
          end
        end
      ...
      def test_assert_nothing_thrown
        check_nothing_fails do
          assert_nothing_thrown("mes***REMOVED***ge") do
            1 + 1
          end
        end
      ...
      def test_assert_operator
        check_nothing_fails {
          assert_operator("thing", :==, "thing", "mes***REMOVED***ge")
        }
        check_fail(%Q{<0.15>\ngiven as the operator for #assert_operator must be a Symbol or #respond_to?(:to_str).}) do
          assert_operator("thing", 0.15, "thing")
        end
        check_fail(%Q{mes***REMOVED***ge.\n<"thing1"> was expected to be\n==\n<"thing2">.}) {
          assert_operator("thing1", :==, "thing2", "mes***REMOVED***ge")
        }
      end

      def test_assert_not_operator
        check_nothing_fails {
          assert_not_operator("thing", :==, "Thing", "mes***REMOVED***ge")
        }
        check_fail(%Q{<42>\ngiven as the operator for #assert_not_operator must be a Symbol or #respond_to?(:to_str).}) do
          assert_not_operator("thing", 42, "mes***REMOVED***ge")
        end
        check_fail(%Q{mes***REMOVED***ge.\n<0> was expected to not be\n==\n<0.0>.}) {
          assert_not_operator(0, :==, 0.0, "mes***REMOVED***ge")
        }
      end

      def test_assert_respond_to
        check_nothing_fails {
          assert_respond_to("thing", :to_s, "mes***REMOVED***ge")
        }
        check_nothing_fails {
          assert_respond_to("thing", "to_s", "mes***REMOVED***ge")
        }
        ...
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "(Class: <Symbol>)") {
          assert_respond_to(:symbol, :nonexistence, "mes***REMOVED***ge")
        }
      end

      def test_assert_not_respond_to_pass_symbol
        check_nothing_fails do
          assert_not_respond_to("thing", :nonexistent, "mes***REMOVED***ge")
        end
      end
      ...
      def tset_assert_not_respond_to_fail_existence
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "(Class: <Symbol>)") do
          assert_respond_to(:symbol, :to_s, "mes***REMOVED***ge")
        end
      end
      ...
      def test_assert_send
        ...
        check_nothing_fails do
          assert_send([object, :return_argument, true, "bogus"], "mes***REMOVED***ge")
        end

        inspected_object = AssertionMes***REMOVED***ge.convert(object)
        expected_mes***REMOVED***ge = <<-EOM
mes***REMOVED***ge.
<#{inspected_object}> was expected to respond to
<return_argument(*[false, "bogus"])> with a true value but was
<false>.
EOM
        check_fail(expected_mes***REMOVED***ge.chomp) do
          assert_send([object, :return_argument, false, "bogus"], "mes***REMOVED***ge")
        end
      end
      ...
      def test_condition_invariant
        ...
        check_nothing_fails do
          assert_equal(object, object, "mes***REMOVED***ge")
        end
      end
      ...
      def test_assert_boolean
        ...
        check_fail("mes***REMOVED***ge.\n<true> or <false> expected but was\n<\"XXX\">") do
          assert_boolean("XXX", "mes***REMOVED***ge")
        end
      end
      ...
      def test_assert_true
        ...
        check_fail("mes***REMOVED***ge.\n<true> expected but was\n<nil>") do
          assert_true(nil, "mes***REMOVED***ge")
        end
      end
      ...
      def test_assert_false
        ...
        check_fail("mes***REMOVED***ge.\n<false> expected but was\n<:false>") do
          assert_false(:false, "mes***REMOVED***ge")
        end
      end
...
EOM
      ...
      def test_assert_raise_mes***REMOVED***ge
        check_nothing_fails do
          assert_raise_mes***REMOVED***ge("Raise!") do
            raise "Raise!"
          end
        end
        ...
        check_nothing_fails do
          assert_raise_mes***REMOVED***ge(/raise/i) do
            raise "Raise!"
          end
        end

        expected_mes***REMOVED***ge = <<-EOM
<"Expected mes***REMOVED***ge"> exception mes***REMOVED***ge expected but was
<"Actual mes***REMOVED***ge">.
EOM
        check_fail(expected_mes***REMOVED***ge.chomp) do
          assert_raise_mes***REMOVED***ge("Expected mes***REMOVED***ge") do
            raise "Actual mes***REMOVED***ge"
          end
        end

        expected_mes***REMOVED***ge = <<-EOM
<"Expected mes***REMOVED***ge"> exception mes***REMOVED***ge was expected but none was thrown.
EOM
        check_fail(expected_mes***REMOVED***ge.chomp) do
          assert_raise_mes***REMOVED***ge("Expected mes***REMOVED***ge") do
          end
...
<RuntimeError(<XXX>)>.
EOM
        check_fail_exception(expected_mes***REMOVED***ge) do
          assert_raise_kind_of(SystemCallError) do
    ...
    class TestAssert < TestCase
      ...
      def test_fail_false_with_mes***REMOVED***ge
      ...
      def test_fail_with_assertion_mes***REMOVED***ge
        check_fail("user mes***REMOVED***ge.\n" +
                    "placeholder <:in> mes***REMOVED***ge") do
          assert(false, build_mes***REMOVED***ge("user mes***REMOVED***ge",
                                      "placeholder <?> mes***REMOVED***ge",
                                      :in))
        end
      end
      ...
      def test_error_invalid_mes***REMOVED***ge_true
        check_fail("assertion mes***REMOVED***ge must be String, Proc or " +
                    "Test::Unit::Assertions::AssertionMes***REMOVED***ge: " +
                    "<true>(<TrueClass>)") do
          begin
            assert(true, true)
          rescue ArgumentError
            raise AssertionFailedError, $!.mes***REMOVED***ge
          end
        end
      end
      ...
      class TestBlock < self
        def test_with_mes***REMOVED***ge
          if defined?(PowerAssert)
            system_mes***REMOVED***ge = <<-MESSAGE.chomp
              1.to_s == "2"
                |    |
                |    false
                "1"
MESSAGE
            ...
            system_mes***REMOVED***ge = "<false> is not true."
          end
          check_fail("user mes***REMOVED***ge.\n#{system_mes***REMOVED***ge}") do
            assert("user mes***REMOVED***ge") do
              1.to_s == "2"
            end
          end
        end
    ...
    class TestRefute < TestCase
      ...
      class TestFailure < self
        ...
        def test_fail_with_assertion_mes***REMOVED***ge
          check_fail("user mes***REMOVED***ge.\n" +
                       "placeholder <:in> mes***REMOVED***ge") do
            refute(true, build_mes***REMOVED***ge("user mes***REMOVED***ge",
                                       "placeholder <?> mes***REMOVED***ge",
                                       :in))
          end
        end
    ...
    class TestAssertInDelta < TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_in_delta(0.5, 0.4, 0.1, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
          ...
          assert_in_delta(0.5, 0.4, 0.05, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertNotInDelta < Test::Unit::TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_not_in_delta(0.5, 0.4, 0.09, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "<0.5>+<0.11>[0.61]" +
                    ">") do
          assert_not_in_delta(0.5, 0.4, 0.11, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertInEpsilon < TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_in_epsilon(10000, 9000, 0.1, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    ">") do
          assert_in_epsilon(10000, 8999, 0.1, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertNotInEpsilon < Test::Unit::TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_not_in_epsilon(10000, 8999, 0.1, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "<10000>+(<10000>*<0.1>)[11000.0]" +
                    ">") do
          assert_not_in_epsilon(10000, 9000, 0.1, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertInclude < Test::Unit::TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_include([1, 2, 3], 1, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "<4>.") do
          assert_include([1, 2, 3], 4, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertNotInclude < Test::Unit::TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_not_include([1, 2, 3], 5, "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
                    ...
                    "<2>.") do
          assert_not_include([1, 2, 3], 2, "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertNotEmpty < Test::Unit::TestCase
      ...
      def test_pass_with_mes***REMOVED***ge
        check_nothing_fails do
          assert_not_empty([1], "mes***REMOVED***ge")
        end
      end
      ...
      def test_fail_with_mes***REMOVED***ge
        check_fail("mes***REMOVED***ge.\n" +
          ...
          assert_not_empty([], "mes***REMOVED***ge")
        end
      end
    ...
    class TestAssertNotSend < Test::Unit::TestCase
      ...
      def test_pass
        check_nothing_fails do
          assert_not_send([[1, 2], :member?, 4], "mes***REMOVED***ge")
        end
      end
...
EOM
        check_fail(expected_mes***REMOVED***ge.chomp) do
          assert_not_send([[1, 2], :member?, 2], "mes***REMOVED***ge")
        end
      end
    end

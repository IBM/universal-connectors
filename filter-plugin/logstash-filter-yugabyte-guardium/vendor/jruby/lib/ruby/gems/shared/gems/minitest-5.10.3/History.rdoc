...
* 8 minor enhancements:
  ...
  * Improved default error mes***REMOVED***ges for assert and refute. (bhenderson)
...
* 3 minor enhancements:
  ...
  * Inline verification error mes***REMOVED***ges in minitest/mock for GC performance. (zamith)
...
* 1 minor enhancement:
  ...
  * Allow seed to be given via ENV for rake test loader ***REMOVED***dness: eg rake SEED=42.
...
* 2 minor enhancements:
  ...
  * Added extra mes***REMOVED***ge about skipped tests, if any. Di***REMOVED***ble globally with $MT_NO_SKIP_MSG.
...
* 3 minor enhancements:
  ...
  * Improved warning mes***REMOVED***ge about minitest/autorun to address 1.9's minitest/autorun.
...
* 2 minor enhancements:
  ...
  * Added count/size to ParallelEach to fix use w/in stdlib's test/unit. :( (btaitelb)
  * Allow di***REMOVED***bling of info_signal handler in runner. (erikh)
...
* 3 minor enhancements:
  ...
  * TestCase#mes***REMOVED***ge can now take another proc to defer custom mes***REMOVED***ge cost. (ordinaryzelig/bhenderson)
...
* 1 minor enhancement:
  ...
  * Improved assert_equals error mes***REMOVED***ge to point you at #== of member objects. (kcurtin)
...
* 4 major enhancements:
  ...
  * Removed last_error and refactored runner code to be thread***REMOVED***fe.
...
* 4 minor enhancements:
  ...
  * Lock on capture_io for thread ***REMOVED***fety (tenderlove)
...
* 3 bug fixes:
  ...
  * Made 'No visible difference.' mes***REMOVED***ge more clear. (ckrailo)
...
* 3 minor enhancements:
  ...
  * Added caller to deprecation mes***REMOVED***ge.
  * Mock error mes***REMOVED***ges are much prettier.
  * Removed String check for RHS of assert/refute_match. This lets #to_str work properly.

* 1 bug fix:

  * Support drive letter on Windows. Patch provided from MRI by U***REMOVED***ku NAKAMURA. (ayumin)
...
* 3 bug fixes:
  ...
  * Ensure Mock#verify verifies multiple expects of the ***REMOVED***me method. (chastell)
...
* 4 minor enhancements:
  ...
  * Added a ton of tests on spec error mes***REMOVED***ge output.
  * Cleaned up consistency of msg handling on unary expectations.
  * Improved error mes***REMOVED***ges on assert/refute_in_delta.
  * infect_an_assertion no longer checks arity and better handles args.

* 1 bug fix:

  * Fixed error mes***REMOVED***ge on specs when 2+ args and custom mes***REMOVED***ge provided. (chastell)
...
* 5 minor enhancements:
  ...
  * Added nicer error mes***REMOVED***ges for MiniTest::Mock. (phiggins)
...
* 2 bug fixes:
  ...
  * MiniTest::Assertions#refute_empty should use mu_pp in the default mes***REMOVED***ge. (whatthejeff)

=== 2.2.2 / 2011-06-01

* 2 bug fixes:

  * Got rid of the trailing period in mes***REMOVED***ge for assert_equal. (tenderlove)
...
* 3 bug fixes:
  ...
  * Fixed assert_block's mes***REMOVED***ge handling. (nobu)
...
* 4 bug fixes:
  ...
  * Fixed some of the assertion default mes***REMOVED***ges
...
* 10 minor enhancements:
  ...
  * assert_***REMOVED***me error mes***REMOVED***ge now reports in decimal, eg: oid=123. (mattkent)

* 2 bug fixes:

  * Fixed mes***REMOVED***ge on refute_***REMOVED***me to be consistent with assert_***REMOVED***me.
...
* 3 bug fixes:
  ...
  * assert_raises was ignoring passed in mes***REMOVED***ge.
...
* 16 bug fixes:
  ...
  * Got arg order wrong in *_match in tests, mes***REMOVED***ge wrong as a result.
  * Made describe private. For some reason I thought that an attribute of Kernel.
  * Removed di***REMOVED***ble_autorun method, added autorun.rb instead.
...
* 12 minor enhancements:
  ...
  * mes***REMOVED***ge now forces to string... ruby-core likes to pass classes and arrays :(
  ...
  * Switched mes***REMOVED***ge generation into procs for mes***REMOVED***ge deferment.
  * Added skip and renamed fail to flunk.
  * Improved output failure mes***REMOVED***ges for assert_instance_of, assert_kind_of
  * Improved output for assert_respond_to, assert_***REMOVED***me.
...
* 5 bug fixes:
  ...
  * Fixed stupid muscle memory mes***REMOVED***ge bug in assert_send.
...
* 23 minor enhancements:
  ...
  * Improved error mes***REMOVED***ges across the board. Adds your mes***REMOVED***ge to the default.
  ...
  * Removed as much code as I could while still maintaining full functionality.
    ...
    * Removed MiniTest::Unit::run. Unneces***REMOVED***ry.
    * Removed location_of_failure. Unneces***REMOVED***ry.
    * Rewrote test/unit's filter_backtrace. Flog from 37.0 to 18.1
  * Removed assert_send. Google ***REMOVED***ys it is never used.
  * Renamed MiniTest::Unit.autotest to #run.
  * Renamed deny to refute.
  * Rewrote some ugly/confusing default assertion mes***REMOVED***ges.

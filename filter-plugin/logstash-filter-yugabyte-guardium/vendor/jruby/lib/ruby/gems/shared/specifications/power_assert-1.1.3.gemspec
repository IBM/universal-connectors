...
Gem::Specification.new do |s|
  ...
  s.bindir = "exe".freeze
  s.date = "2018-06-24"
  s.description = "Power Assert for Ruby. Power Assert shows each value of variables and method calls in the expression. It is useful for testing, providing which value wasn't correct when the condition is not ***REMOVED***tisfied.".freeze

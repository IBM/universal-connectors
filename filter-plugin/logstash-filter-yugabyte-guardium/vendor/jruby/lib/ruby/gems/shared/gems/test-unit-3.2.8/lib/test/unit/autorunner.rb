    ...
    class AutoRunner
      ...
      def options
        @options ||= OptionParser.new do |o|
          ...
          o.banner += "\nU***REMOVED***ge: #{$0} [options] [-- untouched arguments]"
          ...
          assertion_mes***REMOVED***ge_class = Test::Unit::Assertions::AssertionMes***REMOVED***ge
          o.on("--max-diff-target-string-size=SIZE", Integer,
               ...
               "(#{assertion_mes***REMOVED***ge_class.max_diff_target_string_size})") do |size|
            assertion_mes***REMOVED***ge_class.max_diff_target_string_size = size
          end

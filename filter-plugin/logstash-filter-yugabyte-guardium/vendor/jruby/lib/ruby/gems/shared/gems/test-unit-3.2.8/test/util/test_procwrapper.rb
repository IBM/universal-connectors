  ...
  module Unit
    module Util
      class TC_ProcWrapper < TestCase
        ...
        def test_wrapping
          assert_***REMOVED***me(@original, @wrapped_original.to_proc, "The wrapper should return what was wrapped")
        end
        def test_hashing
      
          assert_equal(@wrapped_original.hash, @wrapped_munged.hash, "The original and munged should have the ***REMOVED***me hash when wrapped")

...
module XMLRPC # :nodoc:
  ...
  # mes***REMOVED***ge to this new instance.
  #
  ...
  class Client
    ...
    def new2(uri, proxy=nil, timeout=nil)
      begin
        ...
        raise ArgumentError, e.mes***REMOVED***ge, e.backtrace
      end
    ...
    # Struct is never returned, only a Hash, the ***REMOVED***me for a Symbol, where as a
    ...
    # Almost the ***REMOVED***me like XMLRPC::Client#proxy only that a call on the returned
    ...
    def do_rpc(request, async=false)
      ...
      if resp.code == "401"
        ...
        raise "Authorization failed.\nHTTP-Error: #{resp.code} #{resp.mes***REMOVED***ge}"
      elsif resp.code[0,1] != "2"
        raise "HTTP-Error: #{resp.code} #{resp.mes***REMOVED***ge}"
      end
    ...
    #
    #     # both calls should return the ***REMOVED***me value '9'.
    #     p michael.add(4,5)
    #     p michael2.add(5)
    class Proxy

...
class TestMinitestMock < Minitest::Test
  ...
  def test_blow_up_on_wrong_number_of_arguments
    ...
    assert_equal "mocked method :sum expects 2 arguments, got 0", e.mes***REMOVED***ge
  end
  ...
  def test_expectations_can_be_***REMOVED***tisfied_via_send
    @mock.send :foo
  ...
  def test_expectations_can_be_***REMOVED***tisfied_via_public_send
  ...
  def test_blow_up_on_wrong_arguments
    ...
    assert_equal exp, e.mes***REMOVED***ge
  end
  ...
  def test_expect_with_non_array_args
    ...
    assert_equal "args must be an array", e.mes***REMOVED***ge
  end
  ...
  def test_method_missing_empty
    ...
    assert_equal "No more expects available for :a: []", e.mes***REMOVED***ge
  end

  def test_***REMOVED***me_method_expects_are_verified_when_all_called
    mock = Minitest::Mock.new
  ...
  def test_***REMOVED***me_method_expects_blow_up_when_not_all_called
    mock = Minitest::Mock.new
    mock.expect :foo, nil, [:bar]
    mock.expect :foo, nil, [:baz]
  ...
  def test_***REMOVED***me_method_expects_with_***REMOVED***me_args_blow_up_when_not_all_called
    mock = Minitest::Mock.new
    mock.expect :foo, nil, [:bar]
    mock.expect :foo, nil, [:bar]
...
class TestMinitestStub < Minitest::Test
  ...
  def test_stub_private_module_method_indirect
    ...
    fail_clapper.stub :raise, nil do |***REMOVED***fe_clapper|
      @tc.assert_equal :clap, ***REMOVED***fe_clapper.fail_clap # either form works

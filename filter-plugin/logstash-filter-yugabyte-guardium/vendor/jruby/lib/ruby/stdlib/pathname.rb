...
class Pathname
  ...
  # to_path is implemented so Pathname objects are u***REMOVED***ble with File.open, etc.
  TO_PATH = :to_path
  ...
  # entries than absolutely neces***REMOVED***ry, but without accessing the filesystem,
  ...
  #
  # This is ***REMOVED***me as <code>self + '..'</code>.
  def parent
    self + '..'
  end
...
class Pathname    # * Find *
  ...
  # be used to control the traver***REMOVED***l.
  #

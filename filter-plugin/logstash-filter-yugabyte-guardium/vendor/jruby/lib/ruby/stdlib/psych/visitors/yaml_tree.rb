    ...
    class YAMLTree < Psych::Visitors::Visitor
      ...
      def initialize emitter, ss, options
        ...
        if @line_width && @line_width < 0
          if @line_width == -1
            # Treat -1 as unlimited line-width, ***REMOVED***me as libyaml does.
            @line_width = nil
          else
      ...
      def visit_Exception o
        dump_exception o, o.mes***REMOVED***ge.to_s
      end
      ...
      def dump_exception o, msg
        ...
        if msg
          @emitter.scalar 'mes***REMOVED***ge', nil, nil, true, false, Nodes::Scalar::ANY
          accept msg
        end

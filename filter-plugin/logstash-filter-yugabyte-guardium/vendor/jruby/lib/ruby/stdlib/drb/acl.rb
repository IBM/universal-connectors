...
# Copyright (c) 2000,2002,2003 Ma***REMOVED***toshi SEKI
#
# acl.rb is copyrighted free software by Ma***REMOVED***toshi SEKI.
# You can redistribute it and/or modify it under the ***REMOVED***me terms as Ruby.

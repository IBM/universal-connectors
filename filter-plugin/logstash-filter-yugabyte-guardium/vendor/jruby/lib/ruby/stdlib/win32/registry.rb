...
=end rdoc
  ...
  class Registry
    ...
    class Error < ::StandardError
      FormatMes***REMOVED***geW = Win32API.new('kernel32.dll', 'FormatMes***REMOVED***geW', 'LPLLPLP', 'L')
      def initialize(code)
        @code = code
        buff = WCHAR_NUL * 1024
        lang = 0
        begin
          len = FormatMes***REMOVED***geW.call(0x1200, 0, code, lang, buff, 1024, 0)
    ...
    # The class of value is ***REMOVED***me as #read method returns.
    #
    ...
    #
    # The meaning of rtype is ***REMOVED***me as #read method.
    #
    def [](name, *rtype)
    ...
    # Class of data must be ***REMOVED***me as which #read
    # method returns.
    #

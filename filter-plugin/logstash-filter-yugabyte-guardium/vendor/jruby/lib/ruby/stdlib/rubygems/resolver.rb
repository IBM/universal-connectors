...
class Gem::Resolver
  ...
  # ***REMOVED***tisfy the Dependencies. This defaults to IndexSet, which will query
  # rubygems.org.
  ...
  def search_for(dependency)
    ...
    if !@soft_missing && possibles.empty?
      @missing << dependency
      exc = Gem::Un***REMOVED***tisfiableDependencyError.new dependency, all
    ...
    # create groups & sources in the ***REMOVED***me loop

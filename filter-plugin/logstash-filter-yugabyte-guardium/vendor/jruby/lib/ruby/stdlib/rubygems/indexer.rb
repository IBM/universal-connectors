...
class Gem::Indexer
  ...
  def build_modern_index(index, file, name)
    ***REMOVED***y "Generating #{name} index"
  ...
  def install_indices
    ...
    ***REMOVED***y "Moving index into production dir #{@dest_directory}" if verbose
  ...
  def update_index
    ...
    ***REMOVED***y "Updating production dir #{@dest_directory}" if verbose

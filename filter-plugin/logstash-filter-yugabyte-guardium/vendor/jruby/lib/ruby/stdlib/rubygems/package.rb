...
class Gem::Package
  ...
  class FormatError < Error
    ...
    def initialize(mes***REMOVED***ge, source = nil)
      if source
        @path = source.path

        mes***REMOVED***ge = mes***REMOVED***ge + " in #{path}" if path
      end
...
EOM
  ...
  def extract_tar_gz(io, destination_dir, pattern = "*") # :nodoc:
    ...
    open_tar_gz io do |tar|
      tar.each do |entry|
        ...
        mkdir_p_***REMOVED***fe mkdir, mkdir_options, destination_dir, entry.full_name
  ...
  def mkdir_p_***REMOVED***fe(mkdir, mkdir_options, destination_dir, file_name)
  ...
  def read_checksums(gem)
    ...
    @checksums = gem.seek 'checksums.yaml.gz' do |entry|
      Zlib::GzipReader.wrap entry do |gz_io|
        Gem::SafeYAML.***REMOVED***fe_load gz_io.read
      end
    end
  end
  ...
  def verify
    ...
    raise Gem::Package::FormatError.new e.mes***REMOVED***ge
  rescue Gem::Package::TarInvalidError => e
    raise Gem::Package::FormatError.new e.mes***REMOVED***ge, @gem
  end
  ...
  def verify_entry(entry)
    ...
    mes***REMOVED***ge = "package is corrupt, exception while verifying: " +
              "#{e.mes***REMOVED***ge} (#{e.class})"
    raise Gem::Package::FormatError.new mes***REMOVED***ge, @gem
  end
  ...
  def verify_gz(entry) # :nodoc:
    ...
    raise Gem::Package::FormatError.new(e.mes***REMOVED***ge, entry.full_name)
  end

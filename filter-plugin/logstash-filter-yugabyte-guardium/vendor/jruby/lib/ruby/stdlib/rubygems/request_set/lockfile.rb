...
class Gem::RequestSet::Lockfile
  ...
  class ParseError < Gem::Exception
    ...
    ##
    # Raises a ParseError with the given +mes***REMOVED***ge+ which was encountered at a
    # +line+ and +column+ while parsing.

    def initialize(mes***REMOVED***ge, column, line, path)
      @line   = line
      @column = column
      @path   = path
      super "#{mes***REMOVED***ge} (at line #{line} column #{column})"
    end

...
keys:
  ...
  :verbose: Verbosity of the gem command. false, true, and :really are the
            levels
  :update_sources: Enable/di***REMOVED***ble automatic updating of repository metadata
  :backtrace: Print backtrace when RubyGems encounters an error
  :gempath: The paths in which to look for gems
  :di***REMOVED***ble_default_gem_server: Force specification of gem server host on push
...
Example:
  ...
  install: --no-wrappers
  update: --no-wrappers
  :di***REMOVED***ble_default_gem_server: true

...
class Gem::Commands::SetupCommand < Gem::Command
  ...
  def check_ruby_version
    ...
    unless required_version.***REMOVED***tisfied_by? Gem.ruby_version
...
By default, this RubyGems will install gem as:
  ...
  def execute
    ...
    ***REMOVED***y "RubyGems #{Gem::VERSION} installed"
    ...
    ***REMOVED***y "RubyGems installed the following executables:"
    ***REMOVED***y bin_file_names.map { |name| "\t#{name}\n" }
    ***REMOVED***y

    unless bin_file_names.grep(/#{File::SEPARATOR}gem$/)
      ***REMOVED***y "If `gem` was installed by a previous RubyGems installation, you may need"
      ***REMOVED***y "to remove it by hand."
      ***REMOVED***y
    end

    if documentation_success
      if options[:document].include? 'rdoc'
        ***REMOVED***y "Rdoc documentation was installed. You may now invoke:"
        ***REMOVED***y "  gem server"
        ***REMOVED***y "and then peruse beautifully formatted documentation for your gems"
        ***REMOVED***y "with your web browser."
        ***REMOVED***y "If you do not wish to install this documentation in the future, use the"
        ***REMOVED***y "--no-document flag, or set it as the default in your ~/.gemrc file. See"
        ***REMOVED***y "'gem help env' for details."
        ***REMOVED***y
      end

      if options[:document].include? 'ri'
        ***REMOVED***y "Ruby Interactive (ri) documentation was installed. ri is kind of like man "
        ***REMOVED***y "pages for Ruby libraries. You may access it like this:"
        ***REMOVED***y "  ri Classname"
        ***REMOVED***y "  ri Classname.class_method"
        ***REMOVED***y "  ri Classname#instance_method"
        ***REMOVED***y "If you do not wish to install this documentation in the future, use the"
        ***REMOVED***y "--no-document flag, or set it as the default in your ~/.gemrc file. See"
        ***REMOVED***y "'gem help env' for details."
        ***REMOVED***y
  ...
  def install_executables(bin_dir)
    ...
    executables.each do |tool, path|
      ***REMOVED***y "Installing #{tool} executable" if @verbose
  ...
  def install_lib(lib_dir)
    ...
    libs.each do |tool, path|
      ***REMOVED***y "Installing #{tool}" if @verbose
  ...
  def install_rdoc
    ...
    if File.writable? gem_doc_dir and
      ...
      ***REMOVED***y "Removing old RubyGems RDoc and ri" if @verbose
      ...
      ***REMOVED***y "Skipping RDoc generation, #{gem_doc_dir} not writable"
      ***REMOVED***y "Set the GEM_HOME environment variable if you want RDoc generated"
    end
  ...
  def install_default_bundler_gem(bin_dir)
    ...
    # Remove gemspec that was ***REMOVED***me version of vendored bundler.
    normal_gemspec = File.join(Gem.default_dir, "specifications", "bundler-#{bundler_spec.version}.gemspec")
    if File.file? normal_gemspec
      File.delete normal_gemspec
    end

    # Remove gem files that were ***REMOVED***me version of vendored bundler.
    ...
    ***REMOVED***y "Bundler #{bundler_spec.version} installed"
  end
  ...
  def remove_old_bin_files(bin_dir)
    ...
    old_bin_files.each do |old_bin_file, new_name|
      ...
      deprecation_mes***REMOVED***ge = "`#{old_bin_file}` has been deprecated. Use `#{new_name}` instead."

      File.open old_bin_path, 'w' do |fp|
        fp.write <<-EOF
#!#{Gem.ruby}

abort "#{deprecation_mes***REMOVED***ge}"
    EOF
      end
      ...
      File.open "#{old_bin_path}.bat", 'w' do |fp|
        fp.puts %{@ECHO.#{deprecation_mes***REMOVED***ge}}
      end
    end
  end
  ...
  def regenerate_binstubs
    ...
    ***REMOVED***y "Regenerating binstubs"

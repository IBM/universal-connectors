...
class Gem::Commands::CertCommand < Gem::Command
  ...
  def add_certificate(certificate) # :nodoc:
    ...
    ***REMOVED***y "Added '#{certificate.subject}'"
  end
  ...
  def build(email)
    ...
    ***REMOVED***y "Certificate: #{cert_path}"

    if key_path
      ***REMOVED***y "Private Key: #{key_path}"
      ***REMOVED***y "Don't forget to move the key file to somewhere private!"
    end
  end
...
For further reading on signing gems see `ri Gem::Security`.
  ...
  def list_certificates_matching(filter) # :nodoc:
    certificates_matching filter do |certificate, _|
      ...
      ***REMOVED***y certificate.subject.to_s
    end
  end
  ...
  def remove_certificates_matching(filter) # :nodoc:
    certificates_matching filter do |certificate, path|
      FileUtils.rm path
      ***REMOVED***y "Removed '#{certificate.subject}'"
    end
  end

...
module Gem::Resolver::Molinillo
  module Delegates
    ...
    module SpecificationProvider
      ...
      # (see Gem::Resolver::Molinillo::SpecificationProvider#requirement_***REMOVED***tisfied_by?)
      def requirement_***REMOVED***tisfied_by?(requirement, activated, spec)
        with_no_such_dependency_error_handling do
          specification_provider.requirement_***REMOVED***tisfied_by?(requirement, activated, spec)
        end
      end

...
class Gem::Requirement
  ...
  ##
  # True if +version+ ***REMOVED***tisfies this Requirement.

  def ***REMOVED***tisfied_by?(version)
  ...
  def ==(other) # :nodoc:
    ...
    # An == check is always neces***REMOVED***ry
    ...
    # that version precision is the ***REMOVED***me

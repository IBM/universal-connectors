...
class Gem::ImpossibleDependenciesError < Gem::Exception
  ...
  def initialize(request, conflicts)
    ...
    super build_mes***REMOVED***ge
  end

  def build_mes***REMOVED***ge # :nodoc:
    requester  = @request.requester
    requester  = requester ? requester.spec.full_name : 'The user'
    dependency = @request.dependency

    mes***REMOVED***ge = "#{requester} requires #{dependency} but it conflicted:\n".dup

    @conflicts.each do |_, conflict|
      mes***REMOVED***ge << conflict.explanation
    end
...
class Gem::Un***REMOVED***tisfiableDependencyError < Gem::DependencyError

  ##
  # The un***REMOVED***tisfiable dependency.  This is a
  ...
  ##
  # Creates a new Un***REMOVED***tisfiableDependencyError for the un***REMOVED***tisfiable
...
Gem::Un***REMOVED***tisfiableDepedencyError = Gem::Un***REMOVED***tisfiableDependencyError # :nodoc:

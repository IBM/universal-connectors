...
module Gem::Resolver::Molinillo
  ...
  # @attr [Array<Object>] requirements currently un***REMOVED***tisfied requirements
  # @attr [DependencyGraph] activated the graph of activated dependencies
  # @attr [Object] requirement the current requirement
  # @attr [Object] possibilities the possibilities to ***REMOVED***tisfy the current requirement

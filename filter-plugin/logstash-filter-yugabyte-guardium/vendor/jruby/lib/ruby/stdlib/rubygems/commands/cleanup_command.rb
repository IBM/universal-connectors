...
If no gems are named all gems in GEM_HOME are cleaned.
  ...
  def execute
    ***REMOVED***y "Cleaning up installed gems..."
  ...
  def uninstall_dep(spec)
    ...
    if options[:dryrun]
      ***REMOVED***y "Dry Run Mode: Would uninstall #{spec.full_name}"
      return
    end

    ***REMOVED***y "Attempting to uninstall #{spec.full_name}"
    ...
    begin
      ...
      ***REMOVED***y "Unable to uninstall #{spec.full_name}:"
      ***REMOVED***y "\t#{e.class}: #{e.mes***REMOVED***ge}"
    end
  ensure

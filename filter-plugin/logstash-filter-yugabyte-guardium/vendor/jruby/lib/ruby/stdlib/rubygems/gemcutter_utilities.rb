...
module Gem::GemcutterUtilities
  ...
  def host
    configured_host = Gem.host unless
      Gem.configuration.di***REMOVED***ble_default_gem_server
  ...
  def get_otp
    ***REMOVED***y 'You have enabled multi-factor authentication. Please enter OTP code.'
    ask 'Code: '
  end
  ...
  def sign_in(sign_in_host = nil)
    ...
    ***REMOVED***y "Enter your #{pretty_host} credentials."
    ***REMOVED***y "Don't have an account yet? " +
  ...
  def with_response(response, error_prefix = nil)
    ...
    when Net::HTTPSuccess then
      if block_given?
        ...
        ***REMOVED***y clean_text(response.body)
      end
    else
      mes***REMOVED***ge = response.body
      mes***REMOVED***ge = "#{error_prefix}: #{mes***REMOVED***ge}" if error_prefix

      ***REMOVED***y clean_text(mes***REMOVED***ge)
      terminate_interaction(ERROR_CODE)
    end
  end

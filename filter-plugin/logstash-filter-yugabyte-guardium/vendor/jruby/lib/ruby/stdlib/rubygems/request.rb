...
class Gem::Request
  ...
  def self.verify_certificate(store_context)
    ...
    extra_mes***REMOVED***ge = verify_certificate_mes***REMOVED***ge number, cert

    ui.alert_error extra_mes***REMOVED***ge if extra_mes***REMOVED***ge
  end

  def self.verify_certificate_mes***REMOVED***ge(error_number, cert)
    return unless cert
    case error_number
  ...
  def connection_for(uri)
    @connection_pool.checkout
         ...
         Errno::EHOSTDOWN => e
    raise Gem::RemoteFetcher::FetchError.new(e.mes***REMOVED***ge, uri)
  end
  ...
  def perform_request(request) # :nodoc:
    ...
    begin
      ...
      verbose "#{response.code} #{response.mes***REMOVED***ge}"

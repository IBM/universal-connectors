...
require 'rubygems/install_mes***REMOVED***ge' # must come before rdoc for mes***REMOVED***ging
...
command to remove old versions.
  ...
  def check_latest_rubygems(version) # :nodoc:
    if Gem.rubygems_version == version
      ***REMOVED***y "Latest version already installed. Done."
  ...
  def execute
    ...
    if options[:explain]
      ***REMOVED***y "Gems to update:"

      gems_to_update.each do |name_tuple|
        ***REMOVED***y "  #{name_tuple.full_name}"
      end

      return
    end

    ***REMOVED***y "Updating installed gems"
    ...
    if updated.empty?
      ***REMOVED***y "Nothing to update"
    else
      ***REMOVED***y "Gems updated: #{updated_names.join(' ')}"
      ***REMOVED***y "Gems already up-to-date: #{not_updated_names.join(' ')}" unless not_updated_names.empty?
    end
  end
  ...
  def install_rubygems(version) # :nodoc:
    ...
    Dir.chdir update_dir do
      ***REMOVED***y "Installing RubyGems #{version}"

      installed = system Gem.ruby, '--di***REMOVED***ble-gems', 'setup.rb', *args
      ***REMOVED***y "RubyGems system software updated" if installed
    end
  end

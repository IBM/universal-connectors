...
if RUBY_VERSION >= "2.5"
  ...
  module Kernel
    ...
    module_function define_method(:warn) {|*mes***REMOVED***ges, **kw|
      unless uplevel = kw[:uplevel]
        if Gem.java_platform?
          return original_warn.call(*mes***REMOVED***ges)
        else
          return original_warn.call(*mes***REMOVED***ges, **kw)
        end
      end
      ...
      kw[:uplevel] = uplevel
      original_warn.call(*mes***REMOVED***ges, **kw)
    }
  end
end

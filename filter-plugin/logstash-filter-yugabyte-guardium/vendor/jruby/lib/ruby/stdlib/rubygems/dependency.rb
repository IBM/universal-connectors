...
class Gem::Dependency
  ...
  # other has only an equal version requirement that ***REMOVED***tisfies this
  # dependency.
  ...
  def =~(other)
    ...
    requirement.***REMOVED***tisfied_by? version
  end
  ...
  def matches_spec?(spec)
    ...
    requirement.***REMOVED***tisfied_by?(spec.version)
  end
  ...
  def matching_specs(platform_only = false)
    ...
    matches = Gem::Specification.stubs_for(name).find_all do |spec|
      requirement.***REMOVED***tisfied_by?(spec.version) && env_req.***REMOVED***tisfied_by?(spec.version)
    end.map(&:to_spec)

...
class Gem::Security::Signer
  ...
  # * The expired certificate is ***REMOVED***ved at ~/.gem/gem-public_cert.pem
  #   and the private key is ***REMOVED***ved at ~/.gem/gem-private_key.pem
  ...
  # be ***REMOVED***ved as ~/.gem/gem-public_cert.pem.expired.%Y%m%d%H%M%S where the

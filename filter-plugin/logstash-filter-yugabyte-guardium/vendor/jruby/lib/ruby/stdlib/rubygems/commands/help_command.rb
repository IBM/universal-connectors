...
class Gem::Commands::HelpCommand < Gem::Command
  ...
  # :stopdoc:
  EXAMPLES = <<-EOF.freeze
Some examples of 'gem' u***REMOVED***ge.
...
RubyGems matches platforms as follows:
  ...
  * The CPU must match exactly unless one of the platforms has
    "univer***REMOVED***l" as the CPU or the local CPU starts with "arm" and the gem's
...
Example platforms:
  ...
  univer***REMOVED***l-darwin-8 # Darwin 8 only gems that run on any CPU

...
module Gem
  ...
  class MissingSpecVersionError < MissingSpecError
    ...
    def build_mes***REMOVED***ge
      if name == "bundler" && mes***REMOVED***ge = Gem::BundlerVersionFinder.missing_version_mes***REMOVED***ge
  ...
  class ConflictError < LoadError
    ...
    def initialize(target, conflicts)
      ...
      # TODO: improve mes***REMOVED***ge by ***REMOVED***ying who activated `con`
  ...
  # was found, but that it isn't u***REMOVED***ble on the current platform.
  #
  ...
  class SourceFetchProblem < ErrorReason
    ...
    def wordy
      ...
      "Unable to download data from #{@source.uri} - #{@error.mes***REMOVED***ge}"
    end

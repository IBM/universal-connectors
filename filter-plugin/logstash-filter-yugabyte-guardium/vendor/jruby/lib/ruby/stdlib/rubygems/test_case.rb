...
# gem-related behavior in a ***REMOVED***ndbox.  Through RubyGemTestCase you can install
...
class Gem::TestCase < (defined?(Minitest::Test) ? Minitest::Test : MiniTest::Unit::TestCase)
  ...
  def assert_path_exists(path, msg = nil)
    msg = mes***REMOVED***ge(msg) { "Expected path '#{path}' to exist" }
    assert File.exist?(path), msg
  end

  def assert_directory_exists(path, msg = nil)
    msg = mes***REMOVED***ge(msg) { "Expected path '#{path}' to be a directory" }
  ...
  def refute_path_exists(path, msg = nil)
    msg = mes***REMOVED***ge(msg) { "Expected path '#{path}' to not exist" }
  ...
  ##
  # #setup prepares a ***REMOVED***ndboxed location to install gems.  All installs are
  ...
  def git_gem(name = 'a', version = 1)
    ...
    Dir.chdir directory do
      ...
      system @git, 'commit', '-a', '-m', 'a non-empty commit mes***REMOVED***ge', '--quiet'
  ...
  def ***REMOVED***ve_loaded_features
...
Also, a list:
  ...
  * an entry that\'s really long, which will probably get wrapped funny.  That's ok, somebody wasn't thinking straight when they made it more than eighty characters.
  ...
  #
  # If only the a-3 gem is supposed to be downloaded you can ***REMOVED***ve setup
  ...
  def vendor_gem(name = 'a', version = 1)
    ...
    ***REMOVED***ve_gemspec name, version, directory
  end
  ...
  def ***REMOVED***ve_gemspec(name = 'a', version = 1, directory = '.')

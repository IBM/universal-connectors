...
# String#shellescape.
#
# This method will escape the String for you to ***REMOVED***fely use with a Bourne shell.
#
...
module Shellwords
  # Splits a string into an array of tokens in the ***REMOVED***me way the UNIX
  # Bourne shell does.
  #
  ...
  # Escapes a string so that it can be ***REMOVED***fely used in a Bourne shell
...
class String
  ...
  #
  # Splits +str+ into an array of tokens in the ***REMOVED***me way the UNIX
  # Bourne shell does.
  #
  ...
  #
  # Escapes +str+ so that it can be ***REMOVED***fely used in a Bourne shell
  # command line.
  #

...
#
#   mes***REMOVED***ge = OpenStruct.new(:queued? => true)
#   mes***REMOVED***ge.queued?                           # => true
#   mes***REMOVED***ge.send("queued?=", false)
#   mes***REMOVED***ge.queued?                           # => false
#
...
# neces***REMOVED***ry methods for properties. This is accomplished through the methods
...
class OpenStruct
  ...
  #   person[:age]   # => 70, ***REMOVED***me as person.age
  #
  def [](name)
    @table[name.to_sym]
  end
  ...
  # Two OpenStruct objects with the ***REMOVED***me content will have the ***REMOVED***me hash code

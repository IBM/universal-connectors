...
# and #def_delegators.
#
# For example, ***REMOVED***y you have a class RecordCollection which
...
module Forwardable
  ...
  # ***REMOVED***mples have the ***REMOVED***me effect:
  #
  #   def_delegators :@records, :size, :<<, :map
  #
...
module SingleForwardable
  ...
  # the method of the ***REMOVED***me name in _accessor_).  If _new_name_ is

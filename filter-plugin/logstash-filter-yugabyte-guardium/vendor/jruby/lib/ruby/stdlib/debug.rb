...
if $SAFE > 0
  STDERR.print "-r debug.rb is not available in ***REMOVED***fe mode\n"
  exit 1
end
...
#   end
#
# This will cause Ruby to interrupt execution and show a prompt when the +***REMOVED***y+
# method is run.
#
...
#
# Debug is not available in ***REMOVED***fe mode.
...
EOHELP
  ...
  class << DEBUGGER__
    ...
    #
    # See DEBUGGER__ for more u***REMOVED***ge
    def display
      @display
    end

...
module Zlib
  ...
  class ZStream < FFI::Struct
    ...
    def end
      ...
      Zlib.handle_error err, mes***REMOVED***ge
  ...
  class GzipReader < GzipFile # HACK use a buffer class
    ...
    # +io+ must have a +read+ method that behaves ***REMOVED***me as the +read+ method in
    # IO class.
    #
    ...
    def read(length = nil)
      ...
      raise GzipFile::Error, e.mes***REMOVED***ge
    end
  ...
  class GzipWriter < GzipFile # HACK use a buffer class
    ...
    # should be the ***REMOVED***me as the arguments of Zlib::Deflate.new.  The
    # GzipWriter object writes gzipped data to +io+.  At least, +io+ must
    # respond to the +write+ method that behaves ***REMOVED***me as write method in IO
    # class.
    ...
    # of +flush+ is ***REMOVED***me as in Zlib::Deflate#deflate.
  ...
  class Inflate < ZStream
    ...
    def initialize(window_bits = Zlib::MAX_WBITS)
      ...
      Zlib.handle_error err, mes***REMOVED***ge # HACK
  ...
  def self.handle_error(error, mes***REMOVED***ge = nil)
    return if error == Zlib::OK

    mes***REMOVED***ge = zError error if mes***REMOVED***ge.nil?
    ...
    klass = case error
            ...
            when Errno then Errno.handle mes***REMOVED***ge
            else
              mes***REMOVED***ge = "unknown zlib error #{error}: #{mes***REMOVED***ge}"
              Zlib::Error
            end

    raise klass, mes***REMOVED***ge
  end

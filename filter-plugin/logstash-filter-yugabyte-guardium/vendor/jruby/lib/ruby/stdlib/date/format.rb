...
class Date
  ...
  module Format # :nodoc:
    ...
    DAYS = {
      ...
      'thursday' => 4, 'friday'   => 5, '***REMOVED***turday' => 6
    }.freeze
    ...
    ZONES = {
      ...
      'mesz'=>  2*3600, '***REMOVED***st'=>  2*3600, 'sst' =>  2*3600,
      ...
      'jeru***REMOVED***lem'             =>    7200, 'korea'                 =>   32400,
      ...
      'pacific ***REMOVED***'            =>  -14400, 'pacific'               =>  -28800,
      'romance'               =>    3600, 'russian'               =>   10800,
      '***REMOVED*** eastern'            =>  -10800, '***REMOVED*** pacific'            =>  -18000,
      '***REMOVED*** western'            =>  -14400, '***REMOVED***moa'                 =>  -39600,

          ...
          (n-2).downto(0) do |i|
            ...
            ***REMOVED*** = 0.0
            ...
            if (@e[i] < 0.0)
              ...
              l = i
              if (@e[i] == 0)
                cdivr, cdivi = cdiv(-ra, -***REMOVED***, w, q)
                @h[i][n-1] = cdivr
                @h[i][n] = cdivi
              else
                ...
                cdivr, cdivi = cdiv(x*r-z*ra+q****REMOVED***, x*s-z****REMOVED***-q*ra, vr, vi)
                @h[i][n-1] = cdivr
                @h[i][n] = cdivi
                if (x.abs > (z.abs + q.abs))
                  @h[i+1][n-1] = (-ra - w * @h[i][n-1] + q * @h[i][n]) / x
                  @h[i+1][n] = (-***REMOVED*** - w * @h[i][n] - q * @h[i][n-1]) / x
                else

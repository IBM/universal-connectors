...
module Benchmark
  ...
  # reports with labels. +label_width+ and +labels+ parameters have the ***REMOVED***me
  ...
  # the tests twice, the first time as a rehear***REMOVED***l in order to get the
  ...
  def bmbm(width = 0) # :yield: job
    ...
    # rehear***REMOVED***l
    puts 'Rehear***REMOVED***l '.ljust(width+CAPTION.length,'-')

...
module RSS
  ...
  class NotWellFormedError < Error
    ...
    # the block ends up in the error mes***REMOVED***ge.
    def initialize(line=nil, element=nil)
      mes***REMOVED***ge = "This is not well formed XML"
      if element or line
        mes***REMOVED***ge << "\nerror occurred"
        mes***REMOVED***ge << " in #{element}" if element
        mes***REMOVED***ge << " at about #{line} line" if line
      end

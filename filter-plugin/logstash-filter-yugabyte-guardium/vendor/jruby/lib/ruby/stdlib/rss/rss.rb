...
module RSS
  ...
  # declared with the ***REMOVED***me name, an OverlappedPrefixError will be raised.
  ...
  class NotAvailableValueError < InvalidRSSError
    ...
    def initialize(tag, value, attribute=nil)
      ...
      mes***REMOVED***ge = "value <#{value}> of "
      mes***REMOVED***ge << "attribute <#{attribute}> of " if attribute
      mes***REMOVED***ge << "tag <#{tag}> is not available."
...
EOC
  ...
  module RootElementMixin
    ...
    def to_xml(type=nil, &block)
      if type.nil? or ***REMOVED***me_feed_type?(type)
        to_s
      else

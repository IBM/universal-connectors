...
module RSS
  ...
  module Atom
    ...
    module DuplicateLinkChecker
      # Checks if there are duplicate links with the ***REMOVED***me type and hreflang attributes
    ...
    class Feed < RSS::Element
      ...
      # Defines the Univer***REMOVED***lly Unique Identifier (UUID) for a Feed or Entry.
      #

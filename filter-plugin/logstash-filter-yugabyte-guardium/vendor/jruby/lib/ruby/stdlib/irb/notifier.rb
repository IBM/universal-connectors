...
module IRB
  ...
  module Notifier
    ...
    class LeveledNotifier < AbstractNotifier
      ...
      # Whether to output mes***REMOVED***ges to the output method, depending on the level
    ...
    # CompositeNotifier#notifiers, and will not output mes***REMOVED***ges of any sort.
    class NoMsgNotifier < LeveledNotifier
      # Creates a new notifier that should not be used to output mes***REMOVED***ges.
      def initialize
        @base_notifier = nil
        @level = 0
        @prefix = ""

...
module IRB
  ...
  class Context
    ...
    def initialize(irb, workspace = nil, input_method = nil, output_method = nil)
      ...
      self.***REMOVED***ve_history = IRB.conf[:SAVE_HISTORY] if IRB.conf[:SAVE_HISTORY]
    ...
    #     # omg
    attr_accessor :echo
    # Whether verbose mes***REMOVED***ges are displayed or not.
    #
    ...
    # Returns whether mes***REMOVED***ges are displayed or not.
    def verbose?
      if @verbose.nil?

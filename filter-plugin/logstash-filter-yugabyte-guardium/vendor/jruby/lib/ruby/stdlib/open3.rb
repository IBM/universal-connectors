...
# the program in the ***REMOVED***me way as for Process.spawn.
#
...
module Open3
  ...
  #   # Collect error mes***REMOVED***ge of pdftops and lpr.
  #   pdf_file = "paper.pdf"
  ...
  #                        :err=>err_w) {|ts|
  #     err_w.close
  #     p err_r.read # error mes***REMOVED***ges of pdftops and lpr.
  #   }
  #

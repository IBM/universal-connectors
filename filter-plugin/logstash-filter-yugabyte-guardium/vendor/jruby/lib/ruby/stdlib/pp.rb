...
class PP < PrettyPrint
  ...
  module PPMethods
    ...
    def guard_inspect_key
      ...
      ***REMOVED***ve = Thread.current[:__recursive_key__][:inspect]

      begin
        Thread.current[:__recursive_key__][:inspect] = {}.taint
        yield
      ensure
        Thread.current[:__recursive_key__][:inspect] = ***REMOVED***ve
      end
    end
    ...
    # A convenience method which is ***REMOVED***me as follows:
    #
    ...
    # A present standard fail***REMOVED***fe for pretty printing any given Object
    def pp_object(obj)

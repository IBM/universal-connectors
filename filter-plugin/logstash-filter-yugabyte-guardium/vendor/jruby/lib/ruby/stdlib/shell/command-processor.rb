...
class Shell
  ...
  class CommandProcessor
    ...
    # call-seq:
    #   tran***REMOVED***ct { block }
    #
    # Executes a block as self
    #
    # Example:
    #   sh.tran***REMOVED***ct { system("ls", "-l") | head > STDOUT }
    def tran***REMOVED***ct(&block)
      begin
    ...
    def out(dev = STDOUT, &block)
      dev.print tran***REMOVED***ct(&block)
    end
    ...
    # * Shell#***REMOVED***fe_unlink(*filenames)
    ...
    # * Shell#mv	<- Shell#move
    # * Shell#cp	<- Shell#copy
    # * Shell#rm_f	<- Shell#***REMOVED***fe_unlink

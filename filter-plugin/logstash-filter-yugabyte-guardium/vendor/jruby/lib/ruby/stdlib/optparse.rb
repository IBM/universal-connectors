...
#     opts.banner = "U***REMOVED***ge: example.rb [options]"
#
...
#         opts.banner = "U***REMOVED***ge: example.rb [options]"
#
#         opts.on("-nNAME", "--name=NAME", "Name to ***REMOVED***y hello to") do |n|
#           args.name = n
#         end
#
...
#
#   #=>
#      # U***REMOVED***ge: example.rb [options]
#      #     -n, --name=NAME                  Name to ***REMOVED***y hello to
...
# conversions behave in the ***REMOVED***me way.
...
#         parser.banner = "U***REMOVED***ge: example.rb [options]"
#         parser.separator ""
...
#         # Try it and see!
#         parser.on_tail("-h", "--help", "Show this mes***REMOVED***ge") do
#           puts parser
#           exit
#         end
...
XXX
  ...
  # Program name to be emitted in error mes***REMOVED***ge and default banner,
  # defaults to $0.
  ...
  def banner
    unless @banner
      @banner = "U***REMOVED***ge: #{program_name} [options]"
  ...
  #
  # Program name to be emitted in error mes***REMOVED***ge and default banner, defaults
  # to $0.
  #
  def program_name
  ...
  class ParseError < RuntimeError
    ...
    #
    # Default stringizing method to emit standard error mes***REMOVED***ge.
    #
    def mes***REMOVED***ge
      reason + ': ' + args.join(' ')
    end

    alias to_s mes***REMOVED***ge
  end
  ...
  module Arguable
    ...
    # in the block, it is rescued, a error mes***REMOVED***ge printed to STDERR and
    # +nil+ returned.
    #
    def options

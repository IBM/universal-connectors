...
# are in effect by default. Here we di***REMOVED***ble proxy:
#
...
module OpenURI
  ...
  def OpenURI.open_http(buf, target, proxy, options) # :nodoc:
    ...
    io = buf.io
    io.rewind
    io.status = [resp.code, resp.mes***REMOVED***ge]
  ...
  class HTTPError < StandardError
    def initialize(mes***REMOVED***ge, io)
  ...
  class HTTPRedirect < HTTPError
    def initialize(mes***REMOVED***ge, io, uri)
      super(mes***REMOVED***ge, io)
      @uri = uri
    end
    attr_reader :uri
  end
  ...
  module Meta
    ...
    # returns an Array that consists of status code and mes***REMOVED***ge.
    ...
    # If there are multiple field with ***REMOVED***me field name,
  ...
  module OpenRead
    ...
    #
    # +mode+ and +perm+ are the ***REMOVED***me as Kernel#open.
    #
    ...
    #  di***REMOVED***ble all HTTP redirects.
    #
    ...
    # The argument +options+ is ***REMOVED***me as OpenURI::OpenRead#open.
    def read(options={})
      self.open(options) {|f|
        str = f.read
        Meta.init str, f

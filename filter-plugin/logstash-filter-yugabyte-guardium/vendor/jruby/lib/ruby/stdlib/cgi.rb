...
# ***REMOVED***me name, except all lower case and without a preceding HTTP_.
...
# element as a String.  The name of this method is the ***REMOVED***me as that
...
#
#   require 'cgi/util'
#   CGI.escapeHTML('U***REMOVED***ge: foo "bar" <baz>')
#
#
...
#   require 'cgi/util'
#   include CGI::Util
#   escapeHTML('U***REMOVED***ge: foo "bar" <baz>')
#   h('U***REMOVED***ge: foo "bar" <baz>') # alias
#
#

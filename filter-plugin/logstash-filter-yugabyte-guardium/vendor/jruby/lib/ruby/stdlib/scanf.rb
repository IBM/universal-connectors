...
# == Description
#
# scanf is an implementation of the C function scanf(3), modified as neces***REMOVED***ry
...
# License:: Distributed on the ***REMOVED***me licensing terms as Ruby itself
#
# == Warranty disclaimer
#
...
module Scanf
  ...
  #
  # The rendered match is then ***REMOVED***ved to an accumulator array, and the
...
class IO
  ...
  #     yes: ***REMOVED***ve interim results and continue (next line)
  #
  ...
  #         yes: fatal failure
  #         no: ***REMOVED***ve interim results and continue
  ...
  # A block is not neces***REMOVED***ry though, as the results will simply
...
class String
  ...
  # Scans the current string until the match is exhausted
  # yielding each match as it is encountered in the string.
  # A block is not neces***REMOVED***ry as the results will simply
  # be aggregated into the final array.
  #
  #   "123 456".block_scanf("%d")
  #   # => [123, 456]

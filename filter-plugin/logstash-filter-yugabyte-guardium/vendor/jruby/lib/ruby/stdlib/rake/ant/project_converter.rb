require 'rexml/parsers/***REMOVED***x2parser'
require 'rexml/***REMOVED***x2listener'
require 'rake/ant'
...
class Rake::Ant
  class ProjectConverter
    ...
    def emit(code, attributes = nil)
      print_with_indent ***REMOVED***fe_method_name(code, attributes)
      if attributes
        first = true
    ...
    def ***REMOVED***fe_method_name(s, attributes)
      s = Ant.***REMOVED***fe_method_name(s)
      if s =~ ID
        s
      else

...
# routines.
#
# Copyright (c) 1999-2000,2002,2003 Ma***REMOVED***toshi SEKI
#
...
# == Character encodings
#
# ERB (or Ruby code generated by ERB) returns a string in the ***REMOVED***me
...
#   }.gsub(/^  /, '')
#
#   mes***REMOVED***ge = ERB.new(template, 0, "%<>")
#
...
#
#    <html>
#      <head><title>Ruby Toys -- Ruby***REMOVED***pien</title></head>
#      <body>
#
#        <h1>Ruby***REMOVED***pien (TZ-1002)</h1>
...
# * ERB's big brother, eRuby, works the ***REMOVED***me but is written in C for speed;
...
class ERB
  ...
  # the completed template when run. If _***REMOVED***fe_level_ is set to a non-nil value,
  ...
  # templates through the ***REMOVED***me binding and/or when you want to control where
  ...
  #                :desc => "A well mes***REMOVED***ges pattie, breaded and fried.",
  #                :cost => 9.95 }
  #
  ...
  #
  #  Chicken Fried Steak
  #  A well mes***REMOVED***ges pattie, breaded and fried.
  #
  #  Chicken Fried Steak -- 9.95
  #  A well mes***REMOVED***ges pattie, breaded and fried.
  #
  def initialize(str, ***REMOVED***fe_level=nil, trim_mode=nil, eoutvar='_erbout')
  ...
  # can be affected by _***REMOVED***fe_level_.)
  #

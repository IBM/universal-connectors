...
class BasicSocket < IO
  ...
  #
  # sendmsg sends a mes***REMOVED***ge using sendmsg(2) system call in blocking manner.
  #
  ...
  #
  # sendmsg_nonblock sends a mes***REMOVED***ge using sendmsg(2) system call in non-blocking manner.
  #
  ...
  #
  # recvmsg receives a mes***REMOVED***ge using recvmsg(2) system call in blocking manner.
  #
  ...
  #
  # :scm_rights option specifies that application expects SCM_RIGHTS control mes***REMOVED***ge.
  # If the value is nil or false, application don't expects SCM_RIGHTS control mes***REMOVED***ge.
  # In this case, recvmsg closes the passed file descriptors immediately.
  # This is the default behavior.
  #
  # If :scm_rights value is neither nil nor false, application expects SCM_RIGHTS control mes***REMOVED***ge.
  # In this case, recvmsg creates IO objects for each file descriptors for
  # Socket::AncillaryData#unix_rights method.
  #
  # The return value is 4-elements array.
  #
  # _mesg_ is a string of the received mes***REMOVED***ge.
  #
  # _sender_addrinfo_ is a sender socket address for connection-less socket.
  # It is an Addrinfo object.
  # For connection-oriented socket such as TCP, sender_addrinfo is platform dependent.
  #
  # _rflags_ is a flags on the received mes***REMOVED***ge which is bitwise OR of MSG_* constants such as Socket::MSG_TRUNC.
  ...
  # In that case, the buffer will be grown until the mes***REMOVED***ge is not truncated.
  ...
  #
  # recvmsg receives a mes***REMOVED***ge using recvmsg(2) system call in non-blocking manner.
  #
...
class Socket < BasicSocket
  ...
  #     retry
  #   end
  #   puts "The client ***REMOVED***id, '#{client_socket.readline.chomp}'"
  ...
  #   puts "The server ***REMOVED***id, '#{socket.readline.chomp}'"
  #   socket.close
  #
  ...
  # However all sockets in the result has ***REMOVED***me port number.
  #
  ...
  #
  #   # IPv6 and IPv4 socket has ***REMOVED***me port number, 53114, even if it is chosen dynamically.
  ...
  #
  # It calls the block for each mes***REMOVED***ge received.
  #
  ...
  #
  # creates a UDP/IP server on _port_ and calls the block for each mes***REMOVED***ge arrived.
  # The block is called with the mes***REMOVED***ge and its source information.
  #
  ...
  #   }
  #
  def self.udp_server_loop(host=nil, port, &b) # :yield: mes***REMOVED***ge, mes***REMOVED***ge_source
    udp_server_sockets(host, port) {|sockets|
  ...
  # This is ***REMOVED***fe only if the directory of _path_ is not changed by a malicious user.
  # So don't use /tmp/malicious-users-directory/socket.
  # Note that /tmp/socket and /tmp/your-private-directory/socket is ***REMOVED***fe assuming that /tmp has sticky bit.
  #
  #   # Sequential echo server.
  #   # It services only one client at a time.

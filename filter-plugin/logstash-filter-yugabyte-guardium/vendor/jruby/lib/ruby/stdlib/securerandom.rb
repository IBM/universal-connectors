...
module Random::Formatter
  ...
  # SecureRandom.url***REMOVED***fe_base64 generates a random URL-***REMOVED***fe base64 string.
  #
  # The argument _n_ specifies the length, in bytes, of the random number
  # to be generated. The length of the result string is about 4/3 of _n_.
  #
  ...
  #
  #   p SecureRandom.url***REMOVED***fe_base64 #=> "b4GOKm4pOYU_-BOXcrUGDg"
  #   p SecureRandom.url***REMOVED***fe_base64 #=> "UZLdOkzop70Ddx-IJR0ABg"
  #
  #   p SecureRandom.url***REMOVED***fe_base64(nil, true) #=> "i0XQ-7gglIsHGV2_BNPrdQ=="
  #   p SecureRandom.url***REMOVED***fe_base64(nil, true) #=> "-M8rLhr7JEpJlqFGUMmOxg=="
  #
  # If a secure random number generator is not available,
  # +NotImplementedError+ is raised.
  #
  # See RFC 3548 for the definition of URL-***REMOVED***fe base64.
  def url***REMOVED***fe_base64(n=nil, padding=false)
  ...
  # SecureRandom.uuid generates a random v4 UUID (Univer***REMOVED***lly Unique IDentifier).
  #
  #   p SecureRandom.uuid #=> "2d931510-d99f-494a-8c67-87feb05e1594"
  #   p SecureRandom.uuid #=> "bad85eb9-0713-4da7-8d36-07a8e4b00eab"

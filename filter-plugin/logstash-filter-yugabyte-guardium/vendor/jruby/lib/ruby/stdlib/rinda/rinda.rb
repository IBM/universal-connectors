...
# == Example(s)
#
# See the ***REMOVED***mple/drb/ directory in the Ruby distribution, from 1.8.2 onwards.
#
#--
# TODO
...
module Rinda
  ...
  # the template are the ***REMOVED***me size.
  ...
  class Template < Tuple
    ...
    ##
    # Matches this template against +tuple+.  The +tuple+ must be the ***REMOVED***me
  ...
  class DRbObjectTemplate
    ...
    # drbref are the ***REMOVED***me.  +nil+ is used as a wildcard.

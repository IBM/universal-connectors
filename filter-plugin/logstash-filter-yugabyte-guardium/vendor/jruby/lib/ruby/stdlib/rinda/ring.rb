...
module Rinda
  ...
  # allows multiple RingServers to run on the ***REMOVED***me host.  To use network
  ...
  # properly.  This allows you to run multiple RingServers on the ***REMOVED***me host:
  #
  ...
  class RingFinger
    ...
    # address in the broadcast list).  The default is 1 (***REMOVED***me as UDP
    # broadcast).
    ...
    def send_mes***REMOVED***ge(address, mes***REMOVED***ge) # :nodoc:
      soc = make_socket(address)

      soc.send(mes***REMOVED***ge, 0)
    rescue
      nil
    ensure
      soc.close if soc

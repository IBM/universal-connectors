...
# License:: You can redistribute it and/or modify it under the ***REMOVED***me term as Ruby.
# Revision:: $Id$
#
...
module URI
  ...
  class Generic
    ...
    #   # =>  "***REMOVED***m"
    #   uri
    #   #=> #<URI::HTTP:0x00000000881d90 URL:http://***REMOVED***m:REDACTED_PASSWORD@my.example.com>
    #
    def user=(user)
      check_user(user)
      set_user(user)
    ...
    #
    #   uri = URI.parse("http://john:S3nsit1ve@my.example.com")
    #   uri.password = "REDACTED_PASSWORD"
    #   # =>  "REDACTED_PASSWORD"
    #   uri
    #   #=> #<URI::HTTP:0x00000000881d90 URL:http://john:REDACTED_PASSWORD@my.example.com>
    #
    ...
    #
    # This method is ***REMOVED***me as URI::Generic#host except
    ...
    def merge(oth)
      ...
      if rel.absolute?
        ...
        # hmm... should return oth for u***REMOVED***bility?
        return rel
      end
      ...
      if name == 'http_proxy' && env.include?('REQUEST_METHOD') # CGI?
        ...
        when 1
          ...
          if k == 'http_proxy' && env[k.upcase] == nil
            # http_proxy is ***REMOVED***fe to use because ENV is case sensitive.
            proxy_uri = env[name]
          else
            proxy_uri = nil
          end
        else # http_proxy is ***REMOVED***fe to use because ENV is case sensitive.

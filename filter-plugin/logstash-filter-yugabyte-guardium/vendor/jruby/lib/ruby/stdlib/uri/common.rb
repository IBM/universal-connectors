...
module URI
  ...
  # module for escaping un***REMOVED***fe characters with codes.
  module Escape
    #
    # == Synopsis
    #
    #   URI.escape(str [, un***REMOVED***fe])
    #
    # == Args
    #
    # +str+::
    ...
    # == Description
    #
    # Escapes the string, replacing all un***REMOVED***fe characters with codes.
    #
  ...
  #
  # URI is valid, bad u***REMOVED***ge is not.
  #

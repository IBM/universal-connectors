...
module ExceptionForMatrix # :nodoc:
  ...
  def_e2mes***REMOVED***ge(TypeError, "wrong argument type %s (expected %s)")
  def_e2mes***REMOVED***ge(ArgumentError, "Wrong # of arguments(%d for %d)")
...
class Matrix
  ...
  def ==(other)
    return false unless Matrix === other &&
                        column_count == other.column_count # neces***REMOVED***ry for empty matrices
    rows == other.rows
  end
  ...
  # It has the ***REMOVED***me computational cost order O(n^3) as standard Gaussian elimination.
  ...
  module ConversionHelper # :nodoc:
    ...
    # a copy of obj will be made if neces***REMOVED***ry.
    #
    def convert_to_array(obj, copy = false) # :nodoc:
      ...
      when Vector
        ...
        begin
          ...
          raise TypeError, "can't convert #{obj.class} into an Array (#{e.mes***REMOVED***ge})"
        end
...
class Vector
  ...
  #
  # Returns +true+ iff the two vectors have the ***REMOVED***me elements in the ***REMOVED***me order.
  #
  def ==(other)
  ...
  #
  # Returns a new vector with the ***REMOVED***me direction but with norm 1.

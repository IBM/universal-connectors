...
class Syslog::Logger
  ...
  class Formatter
    ...
    ##
    # Clean up mes***REMOVED***ges so they're nice and pretty.

    def clean mes***REMOVED***ge
      mes***REMOVED***ge = mes***REMOVED***ge.to_s.strip
      mes***REMOVED***ge.gsub!(/\e\[[0-9;]*m/, '') # remove useless ansi color codes
      return mes***REMOVED***ge
    end
  end
  ...
  #
  # Mes***REMOVED***ges from Ruby applications are not considered as critical as mes***REMOVED***ges
  # from other system daemons using syslog(3), so most mes***REMOVED***ges are reduced by
  # one level.  For example, a fatal mes***REMOVED***ge for Ruby's Logger is considered
  ...
  def self.make_methods meth
    ...
    eval <<-EOM, nil, __FILE__, __LINE__ + 1
      def #{meth}(mes***REMOVED***ge = nil, &block)
        add(#{level}, mes***REMOVED***ge, &block)
      end
  ...
  # :method: unknown
  #
  # Logs a +mes***REMOVED***ge+ at the unknown (syslog alert) log level, or logs the
  # mes***REMOVED***ge returned from the block.

  ##
  # :method: fatal
  #
  # Logs a +mes***REMOVED***ge+ at the fatal (syslog err) log level, or logs the mes***REMOVED***ge
  # returned from the block.

  ##
  # :method: error
  #
  # Logs a +mes***REMOVED***ge+ at the error (syslog warning) log level, or logs the
  # mes***REMOVED***ge returned from the block.

  ##
  # :method: warn
  #
  # Logs a +mes***REMOVED***ge+ at the warn (syslog notice) log level, or logs the
  # mes***REMOVED***ge returned from the block.

  ##
  # :method: info
  #
  # Logs a +mes***REMOVED***ge+ at the info (syslog info) log level, or logs the mes***REMOVED***ge
  # returned from the block.

  ##
  # :method: debug
  #
  # Logs a +mes***REMOVED***ge+ at the debug (syslog debug) log level, or logs the
  # mes***REMOVED***ge returned from the block.
  ...
  ##
  # The facility argument is used to specify what type of program is logging the mes***REMOVED***ge.
  ...
  def add severity, mes***REMOVED***ge = nil, progname = nil, &block
    severity ||= ::Logger::UNKNOWN
    @level <= severity and
      @@syslog.log( (LEVEL_MAP[severity] | @facility), '%s', formatter.call(severity, Time.now, progname, (mes***REMOVED***ge || block.call)) )
    true
  end
end

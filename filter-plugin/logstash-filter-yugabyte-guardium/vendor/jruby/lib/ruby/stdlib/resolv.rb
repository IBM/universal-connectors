...
class Resolv
  ...
  class DNS
    ...
    class Requester # :nodoc:
      ...
      def request(sender, tout)
        ...
        while true
          ...
          begin
            msg = Mes***REMOVED***ge.decode(reply)
          rescue DecodeError
            next # broken DNS mes***REMOVED***ge ignored
          end
          if s = sender_for(from, msg)
            break
          else
            # unexpected DNS mes***REMOVED***ge ignored
          end
        end
        return msg, s.data
      end
    ...
    class Mes***REMOVED***ge # :nodoc:
      ...
      def encode
        return Mes***REMOVED***geEncoder.new {|msg|
          msg.put_pack('nnnnnn',
            @id,
            (@qr & 1) << 15 |
            (@opcode & 15) << 11 |
      ...
      class Mes***REMOVED***geEncoder # :nodoc:
        def initialize
          @data = ''.dup
          @names = {}
          yield self
      ...
      def Mes***REMOVED***ge.decode(m)
        o = Mes***REMOVED***ge.new(0)
        Mes***REMOVED***geDecoder.new(m) {|msg|
      ...
      class Mes***REMOVED***geDecoder # :nodoc:
        def initialize(data)
          @data = data
          @index = 0
          @limit = data.bytesize
        ...
        def get_rr
          ...
          res = self.get_length16 do
            begin
              ...
              raise DecodeError, e.mes***REMOVED***ge, e.backtrace
            end
          end
    ...
    class Resource < Query
      ...
      class MINFO < Resource
        ...
        ##
        # Mailbox to use for error mes***REMOVED***ges related to the mail list or mailbox.
      ...
      class LOC < Resource
        ...
        # in thou***REMOVED***ndths of an arc second as an unsigned 32bit integer
      ...
      module IN
        ...
        class SRV < Resource
          ...
          # lowest-numbered priority it can reach; target hosts with the ***REMOVED***me
          ...
          # ***REMOVED***me priority. Larger weights SHOULD be given a proportionately

...
module JRuby
  class VM
    class << self
      ...
      def poll_mes***REMOVED***ge
        CURRENT.queue.poll
      end

      def send_mes***REMOVED***ge(id, obj)
        MAP[id].send(obj)
      end
      ...
      def get_mes***REMOVED***ge
        CURRENT.queue.take
      end

      def each_mes***REMOVED***ge
        while true
          yield get_mes***REMOVED***ge
        end
      end
    end

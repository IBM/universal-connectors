...
module WEBrick
  ...
  module Utils
    ...
    def create_self_signed_cert(bits, cn, comment)
      r***REMOVED*** = OpenSSL::PKey::RSA.new(bits){|p, n|
        case p
      ...
      cert.public_key = r***REMOVED***.public_key

      ef = OpenSSL::X509::ExtensionFactory.new(nil,cert)
      ef.issuer_certificate = cert
      cert.extensions = [
        ef.create_extension("basicConstraints","CA:FALSE"),
        ef.create_extension("keyU***REMOVED***ge", "keyEncipherment"),
        ef.create_extension("subjectKeyIdentifier", "hash"),
        ef.create_extension("extendedKeyU***REMOVED***ge", "serverAuth"),
        ef.create_extension("nsComment", comment),
      ]
      aki = ef.create_extension("authorityKeyIdentifier",
                                "keyid:always,issuer:always")
      cert.add_extension(aki)
      cert.sign(r***REMOVED***, OpenSSL::Digest::SHA256.new)

      return [ cert, r***REMOVED*** ]
    end

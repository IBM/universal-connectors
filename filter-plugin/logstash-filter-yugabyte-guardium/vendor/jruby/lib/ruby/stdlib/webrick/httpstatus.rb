...
module WEBrick
  ...
  module HTTPStatus
    ...
    StatusMes***REMOVED***ge = { # :nodoc:
      ...
      422 => 'Unproces***REMOVED***ble Entity',
      423 => 'Locked',
    ...
    StatusMes***REMOVED***ge.each{|code, mes***REMOVED***ge|
      mes***REMOVED***ge.freeze
      var_name = mes***REMOVED***ge.gsub(/[ \-]/,'_').upcase
      err_name = mes***REMOVED***ge.gsub(/[ \-]/,'')
      ...
      err_class.instance_variable_set(:@reason_phrase, mes***REMOVED***ge)
    ...
    def reason_phrase(code)
      StatusMes***REMOVED***ge[code.to_i]
    end

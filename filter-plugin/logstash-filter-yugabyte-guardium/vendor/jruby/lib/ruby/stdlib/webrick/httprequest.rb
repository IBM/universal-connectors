...
module WEBrick
  ...
  class HTTPRequest
    ...
    # ***REMOVED***me as Mongrel, Thin and Puma
    ...
    def parse_query()
      begin
        ...
        raise HTTPStatus::BadRequest, ex.mes***REMOVED***ge
      end
    end
    ...
    # It's ***REMOVED***id that all X-Forwarded-* headers will contain more than one

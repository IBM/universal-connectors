...
# Copyright (c) 2001 TAKAHASHI Ma***REMOVED***yoshi, GOTOU Yuuzou
  ...
  module HTTPServlet
    ...
    class FileHandler < AbstractServlet
      ...
      def service(req, res)
        ...
        prevent_directory_traver***REMOVED***l(req, res)
        super(req, res)
      end
      ...
      def prevent_directory_traver***REMOVED***l(req, res)
        # Preventing directory traver***REMOVED***l on Windows platforms;
        ...
        if trailing_pathsep?(req.path_info)
          ...
          # Adding a character is a workaround to ***REMOVED***ve it.

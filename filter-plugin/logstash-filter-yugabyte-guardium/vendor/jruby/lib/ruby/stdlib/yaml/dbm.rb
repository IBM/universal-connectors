...
# YAML + DBM = YDBM
#
# YAML::DBM provides the ***REMOVED***me interface as ::DBM.
#
...
class DBM < ::DBM
    ...
    # It ***REMOVED***ys 'DBM#index is deprecated; use DBM#key', but DBM#key
    # behaves not ***REMOVED***me as DBM#index.
    #
    def index( keystr )
    ...
    #
    # Otherwise, ***REMOVED***me as #values_at
    def select( *keys )
        if block_given?

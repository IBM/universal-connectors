...
# YAML::Store provides the ***REMOVED***me functionality as PStore, except it uses YAML
...
class YAML::Store < PStore
  ...
  #   initialize( file_name, thread_***REMOVED***fe = false, yaml_opts = {} )
  #
  # Creates a new YAML::Store object, which will store data in +file_name+.
  # If the file does not already exist, it will be created.
  #
  # YAML::Store objects are always reentrant. But if _thread_***REMOVED***fe_ is set to true,

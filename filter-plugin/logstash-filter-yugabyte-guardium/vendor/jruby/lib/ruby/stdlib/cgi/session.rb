...
class CGI
  ...
  # makes another request with the ***REMOVED***me id, the effect will be to start
  ...
  # using '[]', much the ***REMOVED***me as hashes (although other hash methods
  # are not supported).
  #
  ...
  #                        and provides file-locking and tran***REMOVED***ction support.
  #
  ...
  # ***REMOVED***me name.  If your application switches from one to the other without
  ...
  #
  # If the client has cookies di***REMOVED***bled, the session id must be included
  ...
  #   session.close
  #
  # === Creating a new session ***REMOVED***fely
  #
  #   require 'cgi'
  #   require 'cgi/session'
  #
  ...
  class Session
    ...
    # is _not_ invisible on many browsers; you may wish to di***REMOVED***ble the
    ...
    class MemoryStore
      ...
      # +option+ is a list of initiali***REMOVED***tion options.  None are

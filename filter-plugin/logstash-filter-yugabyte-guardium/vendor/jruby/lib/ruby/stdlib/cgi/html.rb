...
class CGI
  ...
  module HtmlExtension
    ...
    #
    # The checkboxes will all have the ***REMOVED***me +name+ attribute.
    ...
    # to the ***REMOVED***me as the label), or the boolean checked element
    # (defaults to false).
    #
    ...
    # The two-element version omits either the option value (defaults to the ***REMOVED***me
    ...
    #
    # This works the ***REMOVED***me as #checkbox_group().  However, it is not valid

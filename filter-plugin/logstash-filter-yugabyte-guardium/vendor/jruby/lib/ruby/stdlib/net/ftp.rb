...
module Net
  ...
  class FTP < Protocol
    ...
    # The server's welcome mes***REMOVED***ge.
    attr_reader :welcome
    ...
    # tran***REMOVED***ction with binary sendmode of +newmode+.
    #
    # +newmode+ is either +true+ or +false+
    ...
    #            list but alot faster and over the ***REMOVED***me tcp session.
    #

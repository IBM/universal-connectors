...
module Net::HTTPHeader
  ...
  def range
    ...
    # http://tools.ietf.org/html/draft-ietf-httpbis-p1-mes***REMOVED***ging-19#section-3.2.5
  ...
  #
  # Values are URL encoded as neces***REMOVED***ry and the content-type is set to
  ...
  #
  # boundary:: the boundary of the multipart mes***REMOVED***ge
  # charset::  the charset of the mes***REMOVED***ge. All names and the values of

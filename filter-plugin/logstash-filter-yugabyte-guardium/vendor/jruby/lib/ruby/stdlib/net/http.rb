...
# modify this program under the ***REMOVED***me terms of ruby itself ---
...
module Net   #:nodoc:
  ...
  # ***REMOVED***me way using the corresponding request class (Net::HTTP::Put).
  #
  # === Setting Headers
  #
  ...
  # environment variable if it is present.  To di***REMOVED***ble use of +http_proxy+,
  ...
  #
  # Compression can be di***REMOVED***bled through the Accept-Encoding: identity header.
  #
  ...
  #   HTTPUnproces***REMOVED***bleEntity::             422
  #   HTTPLocked::                          423
  ...
  class HTTP < Protocol
    ...
    # detection from the environment.  To di***REMOVED***ble proxy detection set +p_addr+
    # to nil.
    #
      ...
      s = Timeout.timeout(@open_timeout, Net::OpenTimeout) {
        begin
          ...
          raise e, "Failed to open TCP connection to " +
            "#{conn_address}:#{conn_port} (#{e.mes***REMOVED***ge})"
        end
      }
    ...
    #
    # This class is obsolete.  You may pass these ***REMOVED***me parameters directly to

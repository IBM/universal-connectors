...
module REXML
  ...
  # cost of extra memory use.  We ***REMOVED***ve the namespace prefix for the
  ...
  class Element < Parent
    ...
    #
    # Note that this is not the ***REMOVED***me as the document element.
    ...
    def attribute( name, namespace=nil )
      ...
      # now check that prefix'es namespace is not the ***REMOVED***me as the
      # default namespace
  ...
  class Elements
    ...
    #   starting from 1, not 0, and the indexes should be the ***REMOVED***me.
    # name::
  ...
  class Attributes < Hash
    ...
    # ***REMOVED***me name.  Namespace is significant.
    ...
    # ***REMOVED***me name.  Namespaces are significant.

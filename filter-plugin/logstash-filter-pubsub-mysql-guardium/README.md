...
**Note**: For Guardium Data Protection version 11.4 without appliance bundle 11.0p490 or prior or Guardium Data Protection version 11.5 without appliance bundle 11.0p540 or prior, download the [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip) plug-in. (Do not unzip the offline-package file throughout the procedure).
...
* To install this plug-in, you need to download the relevant plugin based on the version of the Guardium.
  1. For the Guardium 11.x, download [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip)
  2. For the Guardium 12.x, download [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip)
...
3. Click Upload File and select the relevant plugin based on the version of the Guardium and after it is uploads, click OK.
    * For Guardium 11.x, download the [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip)
    * For Guardium 12.x, download the [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip)

...
* To install this plug-in, you need to download the relevant plugin based on the version of the Guardium.
  ...
  2. For Guardium 12.x, download the [logstash-filter-pubsub-mysql-guardium.zip](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-pubsub-mysql-guardium.zip)

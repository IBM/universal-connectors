...
module FilterException
    ...
    class BadIPPrefixCloudSQL < FilterError
      def initialize(msg = nil)
        super(msg || "Client IP type mismatched. Please check that the filter's configuration variable cloudsqlproxy_enabled is enabled for Cloud SQL proxy authentication, and vice ver***REMOVED***")

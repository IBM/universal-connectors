...
public class OuaFilterTest {
    ...
    public void testParseCloud() {
        ...
        final String sql_text = "  alter user QA_TEST default role ALL";
        final int server_port = 1521;
        final String account_id = "123456789012";
        final int return_code =0;
        ...
        Assert.assertEquals(1, matchListener.getMatchCount());
        Assert.assertEquals("123456789012:testdb", record.getDbName());
        Assert.assertEquals("123456789012:testdb", record.getAccessor().getServiceName());

...
3. Consume with UC: The data in the Kafka topic is consumed by kafka-input plugin and process by guardium-oua-uc, 
...
## Requirements
1. This feature is currently supported only in environments that use a central manager workflow and a Kafka cluster, in Guardium Data Protection version 12.1.

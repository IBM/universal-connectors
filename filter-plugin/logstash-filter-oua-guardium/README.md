...
4. Click on the "UPLOAD” button and upload downloaded `oracle-instantclient-basic-21.1.0.0.0-1.x86_64.rpm` and then `guardium-oua-uc.zip`
   ...
   5. Click on "+". The Connector Configuration dialog opens 
       ...
       - Type any unique name in the "Connector name" field
         ...
         - Paste content of "[ouaPipe.conf](https://github.com/IBM/universal-connectors/blob/main/filter-plugin/logstash-filter-oua-guardium/ouaPipe.conf)" in the **Input configuration** field
       ...
       - Paste content of "[ouaPipe.conf](https://github.com/IBM/universal-connectors/blob/main/filter-plugin/logstash-filter-oua-guardium/ouaPipe.conf)" in the **Filter configuration** field

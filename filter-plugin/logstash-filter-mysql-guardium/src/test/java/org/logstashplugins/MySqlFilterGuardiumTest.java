...
public class MySqlFilterGuardiumTest {
    ...
    public void testParseMySqlSyslog() {
        final String mysql_mes***REMOVED***ge = "mysql_audit_log: { \"timestamp\": \"2020-08-26 17:31:22\", \"id\": 1, \"class\": \"general\", \"event\": \"status\", \"connection_id\": 42, \"account\": { \"user\": \"guardium_qa\", \"host\": \"\" }, \"login\": { \"user\": \"guardium_qa\", \"os\": \"\", \"ip\": \"192.0.2.1\", \"proxy\": \"\" }, \"general_data\": { \"command\": \"Query\", \"sql_command\": \"select\", \"query\": \"select * from pet\nLIMIT 0, 200\", \"status\": 0 } },";

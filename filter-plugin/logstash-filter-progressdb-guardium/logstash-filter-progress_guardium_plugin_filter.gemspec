...
Gem::Specification.new do |s|
  ...
  s.description     = 'This gem is a Logstash ***REMOVED***phana filter plugin required to be installed as part of IBM Security Guardium, Guardium Univer***REMOVED***l connector configuration. This gem is not a stand-alone program.'
  s.authors         = ['IBM']
  s.email           = ['']

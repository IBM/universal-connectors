...
public class AWSMariaDBGuardiumFilterTest {
	...
	public void ExceptionTest() {
		final String auditString = "20220524 03:23:47,ip-10-19-0-161,admin,223.186.31.18,231,42427,QUERY,Connectors,'select * from sale\nLIMIT 0, 1000',1146";
		Event event = new org.logstash.Event();
		...
		event.setField(ApplicationConstantTest.OBJECT_KEY, "'select * from sale\nLIMIT 0, 1000'");
	...
	public void CONNECTIONTest() {
		final String auditString = "20220527 05:51:28,ip-10-19-0-161,rdsadmin,localhost,1554,0,CONNECT,,,0";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
		event.setField(ApplicationConstantTest.CONNECTIONID_KEY, "1554");
		event.setField(ApplicationConstantTest.USERNAME_KEY, "rdsadmin");
	...
	public void DISCONNECTTest() {
		final String auditString = "20220527 06:17:43,ip-10-19-0-161,rdsadmin,localhost,1559,0,DISCONNECT,,,0";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
	...
	public void INSERTTest() {
		final String auditString = "20220530 10:07:16,ip-10-19-0-187,admin,223.226.69.23,49,7524,QUERY,MariaDB,'INSERT INTO Complxes_Details VALUES(1,\\'reddysa\\')',0";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
		...
		event.setField(ApplicationConstantTest.RETCODE_KEY, "0");
		event.setField(ApplicationConstantTest.OBJECT_KEY, "'INSERT INTO Complxes_Details VALUES(1,\\'reddysa\\')'");
		event.setField(ApplicationConstantTest.HOSTNAME_KEY, "223.226.69.23");
		event.setField(ApplicationConstant.SERVERHOSTNAMEPREFIX_KEY, "979326520502-database-mariadbtest");
		event.setField(ApplicationConstantTest.OPERATION_KEY, "QUERY");
		event.setField("timestamp", "20220527 12:21:14");

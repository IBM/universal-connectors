...
@LogstashPlugin(name = "alloydb_guardium_filter")
public class AlloyDBGuardiumFilter implements Filter {

  private static Logger logger = LogManager.getLogger(AlloyDBGuardiumFilter.class);
  ...
  public AlloyDBGuardiumFilter(String id, String filter, Configuration config, Context context) {
    this(id, config, context);
    this.filter = filter;
  }

  public AlloyDBGuardiumFilter(String id, Configuration config, Context context) {
    this.id = id;

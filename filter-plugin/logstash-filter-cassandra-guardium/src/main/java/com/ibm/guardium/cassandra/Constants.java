...
public interface Constants {
	...
	public static final String LOGSTASH_TAG_JSON_PARSE_ERROR = "_cas***REMOVED***ndraguardium_json_parse_error";
	public static final String LOGSTASH_TAG_SKIP_NOT_CASSANDRA_DB = "_cas***REMOVED***ndraguardium_skip_not_cas***REMOVED***ndradb";

...
//
package com.ibm.guardium.cas***REMOVED***ndra;
...
@LogstashPlugin(name = "cas***REMOVED***ndra_guardium_plugin_filter")
public class Cas***REMOVED***ndraGuardiumPluginFilter implements Filter {
	...
	private static Logger log = LogManager.getLogger(Cas***REMOVED***ndraGuardiumPluginFilter.class);

	public Cas***REMOVED***ndraGuardiumPluginFilter(String id, Configuration config, Context context) {
		...
		for (Event e : events) {
			if (e.getField(Constants.MESSAGE) instanceof String) {
				...
				try {
					...
					log.error("Cas***REMOVED***ndradb Filter: Error Parsing Event " + exception);

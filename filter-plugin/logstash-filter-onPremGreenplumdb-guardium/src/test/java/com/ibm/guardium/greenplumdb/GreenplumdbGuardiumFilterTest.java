...
public class GreenplumdbGuardiumFilterTest {
	...
	public void filterTest2() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 IST,ec2-user,test1,p1713,th1225320576,172.31.7.158,56116,2022-08-05 06:32:41 IST,0,con7,cmd1,seg0,,dx4,,sx1,LOG,0,statement: DELETE FROM products5 where prod_id = 10;,,,,,,DELETE FROM products5 where prod_id = 10;,0,,postgres.c,1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest3() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 IST,ec2-user,test1,p1713,th1225320576,172.31.7.158,56116,2022-08-05 06:32:41 IST,0,con7,cmd1,seg0,,dx4,,sx1,LOG,0,statement: DELETE FROM products5 where prod_id = 10;,,,,,,DELETE FROM products5 where prod_id = 10;,0,,postmaster.c,1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest4() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966,ec2-user,test1,p1713,th1225320576,172.31.7.158,56116,2022-08-05 06:32:41 IST,0,con7,cmd1,seg0,,dx4,,sx1,LOG,0,statement: DELETE FROM products5 where prod_id = 10;,,,,,,DELETE FROM products5 where prod_id = 10;,0,,postgres.c,1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest5() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 IST,ec2-user,test1,p1713,th1225320576,172.31.7.158,56116,2022-08-05 06:32:41 IST,0,con7,cmd1,seg0,,dx4,,sx1,LOG,0,statement:,,,,,,,0,,postgres.c,1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest6() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 IST,ec2-user,test1,p1713,th1225320576,2001:0db8:85a3:0000:0000:8a2e:0370:7334,56116,2022-08-05 06:32:41 IST,0,con7,cmd1,seg0,,dx4,,sx1,LOG,0,statement: DELETE FROM products5 where prod_id = 10;,,,,,,DELETE FROM products5 where prod_id = 10;,0,,postgres.c,1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest7() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:50:03.128588 UTC,\"ec2-user\",\"template1\",p2244,th-719484800,\"172.31.7.158\",\"56224\",2022-08-05 06:50:03 UTC,0,con7,cmd2,seg0,slice1,,,sx1,\"LOG\",\"0\",\"statement: select * from products;\",,,,,,\"select * from products;\",0,,\"postgres.c\",1243,";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest8() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:50:03.128588 UTC,\"ec2-user\",\"template1\",p2244,th-719484800,\"172.31.7.158\",\"56224\",2022-08-05 06:50:03 UTC,0,con7,cmd2,seg0,slice2,,,sx1,\"LOG\",\"0\",\"statement: select * from products;\",,,,,,\"select * from products;\",0,,\"postgres.c\",1243,";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest9() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 UTC,\"ec2-user\",\"template1\",p1713,th1225320576,\"[local]\",,2022-08-05 06:32:41 UTC,0,con7,cmd1,seg0,,dx4,,sx1,\"LOG\",\"0\",\"statement: CREATE TABLE products5(name varchar(40),prod_id integer,supplier_id integer)DISTRIBUTED BY (prod_id);\",,,,,,\"CREATE TABLE products5(name varchar(40),prod_id integer,supplier_id integer)DISTRIBUTED BY (prod_id);\",0,,\"postgres.c\",1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest10() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 UTC,\"ec2-user\",\"template1\",p1713,th1225320576,\"172.31.7.158\",\"56224\",2022-08-05 06:32:41 UTC,0,con7,cmd1,seg0,,dx4,,sx1,\"LOG\",\"0\",\"statement: CREATE TABLE products5(name varchar(40),prod_id integer,supplier_id integer)DISTRIBUTED BY (prod_id);\",,,,,,\"CREATE TABLE products5(name varchar(40),prod_id integer,supplier_id integer)DISTRIBUTED BY (prod_id);\",0,,\"postgres.c\",1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterTest11() {
		...
		final String mes***REMOVED***ge = "2022-08-05 06:32:41.527966 UTC,\"ec2-user\",\"template1\",p1713,th1225320576,\"172.31.7.158\",\"56224\",2022-08-05 06:32:41 UTC,0,con7,cmd1,seg0,,dx4,,sx1,\"LOG\",\"0\",\"statement: create database \"\"db_cricket\"\";\",,,,,,\"create database \"\"db_cricket\"\"\",0,,\"postgres.c\",1243";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);
	...
	public void filterAuthorizationExceptionTest() {
		...
		final String mes***REMOVED***ge = "2022-08-29 08:19:13.744998 UTC,\"ec2-user\",\"automation_testing\",p1646,th893405312,\"172.31.5.213\",\"38380\",2022-08-29 08:19:13 UTC,916,con12,cmd2,seg0,,dx6,x916,sx1,\"LOG\",\"23505\",\"duplicate key value violates unique constraint \"\"emp_pkey\"\"\",\"Key (id)=(B6717) already exists.\",,,,,\"insert into emp values('B6717', 'Adinarayabna', 'Potta', 200110, '2019-12-10','test');\r\n"
	...
	public void filterAuthenticationExceptionTest() {
		...
		final String mes***REMOVED***ge = "2022-08-29 08:19:13.744998 UTC,\"ec2-user\",\"automation_testing\",p1646,th893405312,\"172.31.5.213\",\"38380\",2022-08-29 08:19:13 UTC,916,con12,cmd2,seg0,,dx6,x916,sx1,\"LOG\",\"23505\",\"no pg_hba.conf entry for host \"[local]\", user \"ankur1500\", database \"testdb\", SSL off\",\"Key (id)=(B6717) already exists.\",,,,,,0,,\"auth.c\",500,";
		List<Event> events = new ArrayList<>();
		Event event = new org.logstash.Event();
		events.add(event);
		event.setField(ApplicationConstantTest.MESSAGE, mes***REMOVED***ge);

...
public class MongodbGuardiumFilterTest {
    ...
    public void testFieldGuardRecord_mongos() {
        ...
        e.setField("mes***REMOVED***ge", mongosString);
        Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
...
/**
    ...
    public void testParseMongoSyslog_localhostIPs_remain() {
        final String mongodString = "<14>Feb 18 08:53:31 qa-db51 mongod: { \"atype\" : \"authCheck\", \"ts\" : { \"$date\" : \"2020-01-16T05:41:30.783-0500\" }, \"local\" : { \"ip\" : \"127.0.0.1\", \"port\" : 10400 }, \"remote\" : { \"ip\" : \"127.0.0.1\", \"port\" : 27017 }, \"users\" : [ { \"user\" : \"realAdmin\", \"db\" : \"admin\" } ], \"roles\" : [ { \"role\" : \"readWriteAnyDatabase\", \"db\" : \"admin\" }, { \"role\" : \"userAdminAnyDatabase\", \"db\" : \"admin\" } ], \"param\" : { \"command\" : \"find\", \"ns\" : \"config.tran***REMOVED***ctions\", \"args\" : { \"find\" : \"tran***REMOVED***ctions\", \"filter\" : { \"lastWriteDate\" : { \"$lt\" : { \"$date\" : \"2020-01-16T05:11:30.782-0500\" } } }, \"projection\" : { \"_id\" : 1 }, \"sort\" : { \"_id\" : 1 }, \"$db\" : \"config\" } }, \"result\" : 0 }";
        final String expectedIP = "127.0.0.1";

        Event e = new org.logstash.Event();
        TestMatchListener matchListener = new TestMatchListener();
        
        e.setField("mes***REMOVED***ge", mongodString); // with "(NONE)" local/remote IPs
        // no server_ip field
    ...
    /**
     * Simulates cut-off towards end of Syslog mes***REMOVED***ge, and tests proper JSON parse error tag is attached 
     * */
    @Test 

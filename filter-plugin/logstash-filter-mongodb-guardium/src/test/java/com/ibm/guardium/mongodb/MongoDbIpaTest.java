...
public class MongoDbIpaTest {
    ...
    final static String mes***REMOVED***geStrForIPTests = "\"mongod: {\n" +
            "    \"atype\": \"authCheck\",\n" +
            "    \"ts\": {\n" +
    ...
    public void testFieldGuardRecord_ip_local_filebeatIpV6() {
        ...
        String mes***REMOVED***geUnderTest = String.format(mes***REMOVED***geStrForIPTests, serverIp, clientIp);
        e.setField("mes***REMOVED***ge", mes***REMOVED***geUnderTest);

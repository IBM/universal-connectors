...
public class ParserTest {
    ...
    public void testParseRecord_createCollection() throws ParseException {
        // skipping dedicated log mes***REMOVED***ges "{ \"atype\" : \"createCollection\", \"ts\" : { \"$date\" : \"2020-05-11T06:24:38.168-0400\" } , \"local\" : { \"ip\" : \"127.0.0.1\", \"port\" : 27017 } , \"remote\" : { \"ip\" : \"127.0.0.1\", \"port\" : 48458 } , \"users\" : [], \"roles\" : [], \"param\" : { \"ns\" : \"test.collection3\" } , \"result\" : 0 }";
    ...
    /**
     * NOT USED: Test authorization error mess***REMOVED***ge can be parsed as usual (query is needed later)
     */
    // @Test 

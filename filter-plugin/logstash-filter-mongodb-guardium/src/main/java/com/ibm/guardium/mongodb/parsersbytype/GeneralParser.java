...
public class GeneralParser extends BaseParser {
    ...
    protected Sentence parseSentence(JsonObject data) {
        ...
        if (AType.GENERAL_SHUTDOWN.equals(aTypeEn)){
            ...
            return buildLogApplicationMes***REMOVED***geSentece(data, sentence);
    ...
    private Sentence buildLogApplicationMes***REMOVED***geSentece(JsonObject data, Sentence sentence) {
        SentenceObject sentenceObject = new SentenceObject("msg", "applicationMes***REMOVED***ge");
        sentenceObject.setType("applicationMes***REMOVED***ge");
        sentence.getObjects().add(sentenceObject);

...
//https://www.mongodb.com/docs/manual/reference/audit-mes***REMOVED***ge/
...
//        }
    ...
    protected String parseDatabaseName(JsonObject param, JsonObject args, JsonObject wholeData) {
        ...
        if (args != null && args.has("$db")) {
            ...
            if (param != null && param.has("db")) { // in "authenticate" error mes***REMOVED***ge
     ...
     *
     * JSON format appreas after "mongod: " string and expected format is the ***REMOVED***me

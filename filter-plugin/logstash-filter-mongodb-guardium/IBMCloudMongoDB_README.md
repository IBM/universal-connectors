...
* Download the [guardium_logstash-offline-plugins-mongo.zip](MongoDBOverIBMCloudKafkaStreams/guardium_logstash-offline-plugins-mongo.zip) plug-in.
...
3. Click **Upload File** and select the offline [guardium_logstash-offline-plugins-mongo.zip](MongoDBOverIBMCloudKafkaStreams/guardium_logstash-offline-plugins-mongo.zip) plug-in. After it is uploaded, click **OK**.

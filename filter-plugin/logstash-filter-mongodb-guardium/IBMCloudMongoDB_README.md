...
* Download the [guardium_logstash-offline-plugins-mongo.zip](MongoDBOverIBMCloudKafkaStreams/guardium_logstash-offline-plugins-mongo.zip) plug-in. This is not necessary for Guardium Data Protection v12.0 and later.
...
3. Click **Upload File** and select the offline [guardium_logstash-offline-plugins-mongo.zip](MongoDBOverIBMCloudKafkaStreams/guardium_logstash-offline-plugins-mongo.zip) plug-in. After it is uploaded, click **OK**. This is not necessary for Guardium Data Protection v12.0 and later.

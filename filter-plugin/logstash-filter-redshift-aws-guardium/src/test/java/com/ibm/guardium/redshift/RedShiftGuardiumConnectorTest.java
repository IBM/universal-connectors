...
public class RedShiftGuardiumConnectorTest {
	...
	"LOG: ALTER DATASHARE ***REMOVED***lesshare ADD TABLE public.tickit_***REMOVED***les_redshift;");
	...
	e.setField("serverHostnamePrefix", "979326520502_guardiumredshift");
	e.setField("sql_query",
	"LOG: select * from ***REMOVED***les1\r\n "
	+ "MINUs\r\n "
	+ "select * from ***REMOVED***les2;\r\n");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502_guardiumredshift");
	e.setField("sql_query",
	"LOG: vacuum sort only ***REMOVED***les to 75 percent");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502_guardiumredshift");
	e.setField("sql_query",
	"LOG: select top 10 * from ***REMOVED***les;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	@Test
	public void testparse_noMes***REMOVED***ge() {
		Context context = new ContextImpl(null, null);
		RedShiftGuardiumConnector filter = new RedShiftGuardiumConnector("rds", null, context);
		Event e = new org.logstash.Event();
		TestMatchListener matchListener = new TestMatchListener();
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: alter database tickit_***REMOVED***ndbox rename to tickit_test;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: ALTER DATABASE ***REMOVED***mpledb ISOLATION LEVEL SNAPSHOT;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	+ "    select   catgroup,\r\n"
	+ "    sum(qtysold) as sold\r\n"
	+ "    from     category c, event e, ***REMOVED***les s\r\n"
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: CREATE MATERIALIZED VIEW mv_***REMOVED***les_vw as\r\n"
	+ "select ***REMOVED***lesid, qtysold, pricepaid, commission, ***REMOVED***letime from public.***REMOVED***les\r\n"
	+ "union all\r\n"
	+ "select ***REMOVED***lesid, qtysold, pricepaid, commission, ***REMOVED***letime from spectrum.***REMOVED***les;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: create materialized view mv_***REMOVED***les_vw as select a from t;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: CREATE ROLE ***REMOVED***mple_role1;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: CREATE ROLE ***REMOVED***mple_role1 EXTERNALID \"ABC123\";");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: DROP ROLE ***REMOVED***mple_role FORCE;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: ALTER ROLE ***REMOVED***mple_role1 WITH RENAME TO ***REMOVED***mple_role2;");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());
	...
	e.setField("serverHostnamePrefix", "979326520502-guardiumredshift");
	e.setField("sql_query",
	"LOG: ALTER ROLE ***REMOVED***mple_role1 EXTERNALID TO \"XYZ456\";");
	Collection<Event> results = filter.filter(Collections.singletonList(e), matchListener);
	Assert.assertEquals(1, results.size());
	Assert.assertNotNull(e.getField(GuardConstants.GUARDIUM_RECORD_FIELD_NAME));
	Assert.assertEquals(1, matchListener.getMatchCount());

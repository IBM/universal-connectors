...
public class Parser {
	 ...
	 *
	 */
	private static SentenceObject parseSentenceObject(String mes***REMOVED***ge) {
		SentenceObject sentenceObject = null;
		sentenceObject = new SentenceObject(mes***REMOVED***ge);
		sentenceObject.setName(mes***REMOVED***ge);

...
# Procedure
	...
	6. Update the input section for JDBC Plugin. Use saphanaJDBC.conf file's input part, omitting the keyword "input{" at the beginning and its corresponding "}" at the end and for FileBeat use saphanaFilebeat.con file's input part.
	7. Update the filter section for JDBC Plugin. Use saphanaJDBC.conf file's filter part, omitting the keyword "filter{" at the beginning and its corresponding "}" at the end and for FileBeat use saphanaFilebeat.con file's filter part.

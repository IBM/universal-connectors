...
public class MariadbGuardiumFilterTest {
	...
	public void TABLEEVENTTest() {
		final String auditString = "20220204 13:49:42,LP-5CD1184J8J,root,localhost,5,25,READ,auditlog,totalsale,";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
		...
		event.setField(ApplicationConstantTest.OBJECT_KEY, "totalsale");
		event.setField(ApplicationConstantTest.HOSTNAME_KEY, "localhost");
		event.setField(ApplicationConstantTest.SERVERHOST_KEY, "LP-5CD1184J8J");
	...
	public void QUERYEVENTTest2() {
		final String auditString = "20220201 14:05:38,LP-5CD1184J8J,root,localhost,4,15,QUERY,auditlog,'insert into auditlog.totalsale(SalepersonName,SoldData,ProductName)values(\\'ash\\',CURRENT_DATE(),\\'MariaDBvmm\\')',0";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
		...
		event.setField(ApplicationConstantTest.RETCODE_KEY, "0");
		event.setField(ApplicationConstantTest.OBJECT_KEY,
				"'insert into auditlog.totalsale(SalepersonName,SoldData,ProductName)values(\\\\'ash\\\\',CURRENT_DATE(),\\\\'MariaDBvmm\\\\')'");
		event.setField(ApplicationConstantTest.HOSTNAME_KEY, "localhost");
		event.setField(ApplicationConstantTest.SERVERHOST_KEY, "LP-5CD1184J8J");
		event.setField(ApplicationConstantTest.OPERATION_KEY, "QUERY");
	...
	public void QUERYEVENTTest3() {
		final String auditString = "20220201 14:06:32,LP-5CD1184J8J,root,localhost,4,16,QUERY,auditlog,'insert into auditlog.totalsale(SalepersonName,SoldData,ProductName)values(\"ashr\",CURRENT_DATE(),\"MariaDBvmms\")',0";
		Event event = new org.logstash.Event();
		ArrayList<Event> list = new ArrayList<>();
		list.add(event);
		event.setField(ApplicationConstantTest.LOG_MESSAGE_KEY, auditString);
		...
		event.setField(ApplicationConstantTest.RETCODE_KEY, "0");
		event.setField(ApplicationConstantTest.OBJECT_KEY,
				"'insert into auditlog.totalsale(SalepersonName,SoldData,ProductName)values(\\\"ashr\\\",CURRENT_DATE(),\\\"MariaDBvmms\\\")'");
		event.setField(ApplicationConstantTest.HOSTNAME_KEY, "localhost");
		event.setField(ApplicationConstantTest.SERVERHOST_KEY, "LP-5CD1184J8J");
		event.setField(ApplicationConstantTest.OPERATION_KEY, "QUERY");
	...
	public void HAVINGTest() {
		final String auditString = "20220501 01:01:53,LP-5CD1184J8J,root,localhost,13,247,QUERY,mariadb,'SELECT genre, SUM(sales) AS \"Total\"\\nFROM booksales\\nWHERE sales < 100\\nGROUP BY country\\nHAVING SUM(sales) > 500',0";

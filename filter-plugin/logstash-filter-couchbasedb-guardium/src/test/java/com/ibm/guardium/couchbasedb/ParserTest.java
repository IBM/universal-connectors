...
public class ParserTest {
    ...
    final String couchbaseString = "{\"clientContextId\":\"5c5476f0-e46d-4a6a-a19b-982a5fea056f\",\"description\":\"A N1QL SELECT statement was executed\",\"id\":28672,\"isAdHoc\":true,\"metrics\":{\"elapsedTime\":\"29.1335ms\",\"executionTime\":\"29.0167ms\",\"resultCount\":3,\"resultSize\":217,\"sortCount\":3},\"name\":\"SELECT statement\",\"node\":\"127.0.0.1:8091\",\"real_userid\":{\"domain\":\"builtin\",\"user\":\"Administrator\"},\"remote\":{\"ip\":\"127.0.0.1\",\"port\":40389},\"requestId\":\"f5592288-044f-453b-bbba-dc7d49e4aeb4\",\"statement\":\"SELECT name,phone FROM `travel-***REMOVED***mple` WHERE type=\\\"hotel\\\" AND city=\\\"Manchester\\\" and directions IS NOT MISSING ORDER BY name LIMIT 10;\",\"status\":\"success\",\"timestamp\":\"2021-05-20T14:41:21.444Z\",\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36 (Couchbase Query Workbench (6.6.2-9588-enterprise))\",\"serverHostname\":\"test.couchbase.com\", \"serverIP\":\"0.0.0.0\"}";
    ...
    public void testForErrorHandling() throws ParseException {
        final String couchbaseString = "{\"clientContextId\":\"79f105ab-075b-41ff-b9d9-2f898ee2be31\",\"description\":\"An unrecognized statement was received by the N1QL query engine\",\"id\":28687,\"isAdHoc\":true,\"metrics\":{\"elapsedTime\":\"1.378ms\",\"errorCount\":1,\"executionTime\":\"1.1121ms\",\"resultCount\":0,\"resultSize\":0},\"name\":\"UNRECOGNIZED statement\",\"node\":\"127.0.0.1:8091\",\"real_userid\":{\"domain\":\"builtin\",\"user\":\"Administrator\"},\"remote\":{\"ip\":\"127.0.0.1\",\"port\":35563},\"requestId\":\"142d2fce-c4fd-48df-99f7-be91232a8e7b\",\"statement\":\"SELECT * FROM beer-***REMOVED***mple` limit 5;\",\"status\":\"fatal\",\"timestamp\":\"2021-06-21T12:13:43.492Z\",\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.106 Safari/537.36 (Couchbase Query Workbench (6.6.2-9600-enterprise))\",\"serverHostname\":\"test.couchbase.com\", \"serverIP\":\"0.0.0.0\"}";
        final JsonObject couchbaseJson = JsonParser.parseString(couchbaseString).getAsJsonObject();
  ...
  //test sessionID
    ...
    public void testParseTimestamp() throws ParseException {
        ...
        final String testString = "{\"description\":\"A N1QL SELECT statement was executed\",\"id\":28672,\"isAdHoc\":true,\"metrics\":{\"elapsedTime\":\"68.6619ms\",\"executionTime\":\"68.5632ms\",\"resultCount\":5,\"resultSize\":82},\"name\":\"SELECT statement\",\"node\":\"127.0.0.1:8091\",\"real_userid\":{\"domain\":\"local\",\"user\":\"Administrator\"},\"remote\":{\"ip\":\"172.17.0.1\",\"port\":58438},\"requestId\":\"3e7e21ab-5530-4a99-8738-c8f9d3d00485\",\"statement\":\"SELECT distinct city FROM `travel-***REMOVED***mple` LIMIT 5\",\"status\":\"success\",\"timestamp\":\"2021-05-25T15:05:59.334Z\",\"userAgent\":\"curl/7.55.1\"}";
    ...
    public void testForUIGeneratedFrequentLogs() throws ParseException {
    	...
    	//frequency very high
    	final String dummy="{\"clientContextId\":\"INTERNAL-6220dcc1-6e1b-49a0-a368-3d30b806a1cc\",\"description\":\"A N1QL SELECT statement was executed\",\"id\":28672,\"isAdHoc\":true,\"metrics\":{\"elapsedTime\":\"19.5885ms\",\"executionTime\":\"19.5122ms\",\"resultCount\":1,\"resultSize\":42},\"name\":\"SELECT statement\",\"node\":\"127.0.0.1:8091\",\"real_userid\":{\"domain\":\"builtin\",\"user\":\"Administrator\"},\"remote\":{\"ip\":\"127.0.0.1\",\"port\":39923},\"requestId\":\"341f2c0f-4024-4f20-82e1-154006b5dd7c\",\"statement\":\"select raw {\\\"beer-***REMOVED***mple\\\" : (select raw count(*) from `beer-***REMOVED***mple`)[0],\\\"travel-***REMOVED***mple\\\" : (select raw count(*) from `travel-***REMOVED***mple`)[0]}\",\"status\":\"success\",\"timestamp\":\"2021-06-24T08:49:39.430Z\",\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.114 Safari/537.36 (Couchbase Query Workbench (6.6.2-9600-enterprise))\"}";

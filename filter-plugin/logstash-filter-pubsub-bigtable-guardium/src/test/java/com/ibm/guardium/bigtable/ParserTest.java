...
class ParserTest {
    ...
    void clusterTest() throws IOException {
        ...
        assertEquals("{\"createinstancetestcluster\":{\"location\":\"projects/my-gcp-project/locations/northamerica-northeast2-a\",\"serveNodes\":1,\"defaultStorageType\":\"SSD\"},\"createinstancetest-c1\":{\"defaultStorageType\":\"SSD\",\"location\":\"projects/my-gcp-project/locations/northamerica-northeast2-c\",\"serveNodes\":1}}",clusters);
    }
    @Test
    ...
    void parseSessionLocatorTest() throws IOException {
        ...
        assertEquals(-1, sessionLocator.getServerPort());
        assertEquals("192.0.2.3", sessionLocator.getClientIp());
        assertEquals(-1, sessionLocator.getClientPort());
    }
    @Test
    ...
    void serviceAccountKeyNameTest() throws IOException {
        ...
        assertEquals("apachesolrgcp-pubsub@my-gcp-project.iam.gserviceaccount.com", principalEmail);
        assertEquals("//iam.googleapis.com/projects/my-gcp-project/serviceAccounts/apachesolrgcp-pubsub@my-gcp-project.iam.gserviceaccount.com/keys/960653a95002d5b9c230ad1631ac38f3aee2123f", serviceAccountKeyName);
        assertEquals("serviceAccount:apachesolrgcp-pubsub@my-gcp-project.iam.gserviceaccount.com", principalSubject);
    }
    ...
    void operationTest() throws IOException {
        ...
        assertEquals("operations/projects/my-gcp-project/instances/createinstancetest/locations/northamerica-northeast2-a/operations/5003528313522199720", id);

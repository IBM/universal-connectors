...
* Download
  the [logstash-filter-trino_guardium_filter](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-trino_guardium_filter.zip)
  plug-in.
...
3. Click ```Upload File``` and select the
   offline  [logstash-filter-trino_guardium_filter](https://github.com/IBM/universal-connectors/releases/download/v1.7.2/logstash-filter-trino_guardium_filter.zip)

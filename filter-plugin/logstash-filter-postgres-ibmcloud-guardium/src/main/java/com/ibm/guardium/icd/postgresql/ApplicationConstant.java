...
public class ApplicationConstant {
	...
	public static final String DESCRIPTION = "Error occured";
	public static final String ERROR_CODE = "ID1";
	public static final String LOGIN_FAILURE = "Authentication failure";
	...
	public static final String SERVER_TYPE_STRING = "POSTGRE";
	public static final String DB_PROTOCOL = "POSTGRESQL";
	public static final String EXCEPTION_TYPE_SQL_ERROR_STRING = "SQL_ERROR";
	public static final String DEFAULT_TIMEZONE = "UTC";
	public static final String MESSAGE = "message";
	public static final String SPACE = " ";
	public static final String USERNAME_KEY = "username";
	public static final String DBNAME_KEY = "db=";
	public static final String CLIENTIP_KEY = "clientip";
	public static final String SOURCE_PROGRAM = "sourceProgram";
	...
	public static final String LOG_SOURCE_CRN = "logSourceCRN";
	public static final String STATEMENT_EVENT = "STATEMENT:";
	public static final String SQL_STATE = "sqlstate";
	public static final String SUCCESS_STATE = "00000";
	public static final String COLON = ":";
	public static final String QUERY = "query";
	public static final String FATAL_EVENT = "FATAL:";
	public static final String SESSION_ID = "sessionid";

	public static final String INCLUDE_ACCOUNTID_IN_HOST = "include_account_in_host";
}

...
Edit the Sink via _Logs Router > Sink Inclusion Filter_:
...
* Download the **logstash-filter-spanner_db_guardium_filter.zip** package from [Universal Connector release page](https://github.com/IBM/universal-connectors/releases) under Assets. (Do not unzip the offline-package file throughout the procedure). This step is not necessary for Guardium Data Protection v12.0 and later.

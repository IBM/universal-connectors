...
![General details](universal-connectors/docs/images/cloudwatch/general_details.png)
...
(For both the role and every instance that will use it: ``"arn:aws:iam::123456789012:role/ec2_single_account_cloudwatch_logs/*"``, ``"arn:aws:iam::123456789012:role/ec2_single_account_cloudwatch_logs"``.)

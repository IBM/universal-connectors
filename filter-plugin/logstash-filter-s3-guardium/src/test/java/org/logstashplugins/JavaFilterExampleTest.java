...
//
//        Assert.assertEquals(1, results.size());
//        Assert.assertNotNull(e.getField("UCRecord"));
...
//
//        Assert.assertEquals(1, results.size());
//        String recordString = e.getField("UCRecord").toString();

...
public class Parser {
    ...
    public static Record buildRecord(JsonElement auditEl) throws Exception {
        ...
        if (!UNKNOWN_STRING.equalsIgnoreCase(errorCode)){
            ...
            exceptionRecord.setDescription(getStrValue(auditObj,"errorMes***REMOVED***ge"));
    ...
    * */
    ...
    public static void main(String[] args){
        ...
        try {
//            String anotherEvent = "{\"eventID\":\"e3de78ee-4fab-40ef-b421-bfeff7f3c61c\",\"awsRegion\":\"us-east-1\",\"eventCategory\":\"Data\",\"eventVersion\":\"1.07\",\"responseElements\":null,\"sourceIPAddress\":\"192.0.2.4\",\"requestParameters\":{\"bucketName\":\"bucketnewbucketkkkkk\",\"X-Amz-Date\":\"20200622T202153Z\",\"response-content-disposition\":\"inline\",\"X-Amz-Algorithm\":\"AWS4-HMAC-SHA256\",\"X-Amz-SignedHeaders\":\"host\",\"Host\":\"bucketnewbucketkkkkk.s3.us-east-1.amazonaws.com\",\"X-Amz-Expires\":\"300\",\"key\":\"mkkkk/***REMOVED***mpleJson.json\"},\"eventSource\":\"s3.amazonaws.com\",\"resources\":[{\"type\":\"AWS::S3::Object\",\"ARN\":\"arn:aws:s3:::bucketnewbucketkkkkk/mkkkk/***REMOVED***mpleJson.json\"},{\"type\":\"AWS::S3::Bucket\",\"ARN\":\"arn:aws:s3:::bucketnewbucketkkkkk\",\"accountId\":\"111111111111\"}],\"readOnly\":true,\"userAgent\":\"[Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36]\",\"userIdentity\":{\"sessionContext\":{\"attributes\":{\"mfaAuthenticated\":\"false\",\"creationDate\":\"2020-06-22T08:52:40Z\"}},\"accessKeyId\":\"ASIAIOSFODNN7EXAMPLE\",\"accountId\":\"111111111111\",\"principalId\":\"AIDAJWW2XAIOY2WN3KAAM\",\"arn\":\"arn:aws:iam::111111111111:user/ProxyTest\",\"type\":\"IAMUser\",\"userName\":\"ProxyTest\"},\"eventType\":\"AwsApiCall\",\"additionalEventData\":{\"SignatureVersion\":\"SigV4\",\"AuthenticationMethod\":\"QueryString\",\"x-amz-id-2\":\"CcbPzGZRlYbGdJPjFp8IcxuVi7ZhB01wkVVwhjkRDFbUDdFB+GKsV5oRannp3oOt2qCMUEXy37I\\u003d\",\"CipherSuite\":\"ECDHE-RSA-AES128-GCM-SHA256\",\"bytesTransferredOut\":19.0,\"bytesTransferredIn\":0.0},\"requestID\":\"4D5B1CD23AEDD7C7\",\"eventTime\":\"2020-06-22T20:21:53Z\",\"eventName\":\"GetObject\",\"recipientAccountId\":\"111111111111\",\"managementEvent\":false}";
//            JsonObject inputJSON = (JsonObject) JsonParser.parseString(anotherEvent);

            String parseErrorEvent = "{ \"mes***REMOVED***ge\" : {\"eventVersion\":\"1.05\",\"userIdentity\":{\"type\":\"Root\",\"principalId\":\"111111111111\",\"arn\":\"arn:aws:iam::111111111111:root\",\"accountId\":\"111111111111\",\"accessKeyId\":\"ASIAIOSFODNN7EXAMPLE\",\"userName\":\"guardiumproxy\",\"sessionContext\":{\"attributes\":{\"mfaAuthenticated\":\"false\",\"creationDate\":\"2020-07-24T18:35:41Z\"}}},\"eventTime\":\"2020-07-24T18:56:42Z\",\"eventSource\":\"s3.amazonaws.com\",\"eventName\":\"GetBucketPublicAccessBlock\",\"awsRegion\":\"us-east-1\",\"sourceIPAddress\":\"108.20.188.184\",\"userAgent\":\"[S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.783 Linux/4.9.217-0.1.ac.205.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.252-b09 java/1.8.0_252 vendor/Oracle_Corporation]\",\"requestParameters\":{\"publicAccessBlock\":[\"\"],\"host\":[\"guardium01.s3.us-east-1.amazonaws.com\"],\"bucketName\":\"guardium01\"},\"responseElements\":null,\"additionalEventData\":{\"SignatureVersion\":\"SigV4\",\"CipherSuite\":\"ECDHE-RSA-AES128-SHA\",\"AuthenticationMethod\":\"AuthHeader\",\"vpcEndpointId\":\"vpce-f40dc59d\"},\"requestID\":\"CB080A8B962B420B\",\"eventID\":\"3a9e5492-e212-4dd9-9829-6aea6c861272\",\"eventType\":\"AwsApiCall\",\"recipientAccountId\":\"111111111111\",\"vpcEndpointId\":\"vpce-f40dc59d\"}}";

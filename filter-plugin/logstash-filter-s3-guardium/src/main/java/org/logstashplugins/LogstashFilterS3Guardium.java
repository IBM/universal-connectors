        ...
        for (Event e : events) {
            try {
                ...
                if (e.getField("detail") !=null ) {
                    ...
                    inputJSON = JsonParser.parseString(e.getField("mes***REMOVED***ge").toString());
                    if (log.isDebugEnabled()) { log.debug("cloudwatch_logs event 'mes***REMOVED***ge' property value " + inputJSON); }

...
//			log.error("Mes***REMOVED***ge received => " + event.getField(ApplicationConstants.MESSAGE));
...
//						log.error("Guard record => " + gson.toJson(record));
					 ...
					 * details of mes***REMOVED***ge are logged for investigation.
					 * 
					 */

...
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.Step;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.Traver***REMOVED***l;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.Traver***REMOVED***l.Admin;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.dsl.graph.GraphTraver***REMOVED***lSource;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.HasContainerHolder;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.Parameterizing;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.filter.DropStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.filter.HasStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.AddEdgeStartStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.AddEdgeStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.AddVertexStartStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.AddVertexStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.EdgeVertexStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.GraphStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.map.VertexStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.sideEffect.AddPropertyStep;
import org.apache.tinkerpop.gremlin.process.traver***REMOVED***l.step.util.HasContainer;
import org.apache.tinkerpop.gremlin.structure.T;
import org.apache.tinkerpop.gremlin.tinkergraph.process.traver***REMOVED***l.step.sideEffect.TinkerGraphStep;
...
public class GremlinParser {
	...
	static {
		...
		ENGINE.put("g", new GraphTraver***REMOVED***lSource(TinkerFactory.createGratefulDead()));
	...
	public static Map<String, List<Object>> parseGremlin(String script) throws Exception {
		...
		try {
			...
			Traver***REMOVED***l stmt = (Traver***REMOVED***l) ((ScriptEngine) ENGINE).eval(script);
...
//			System.out.println("-------------------------------------------------------------------------------");
	 ...
	 * object contains "AddVertex" and vice-ver***REMOVED***.
	 * 
	 * 
	 * @param trav
	 * @param map

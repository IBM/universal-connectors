...
public interface ApplicationConstantTest {
	...
	public static final String CONFIG_VALUE = "mes***REMOVED***ge";

	public static final String LOG_MESSAGE_KEY = "mes***REMOVED***ge";
	public static final String LOG_MESSAGE = "1629182102678, 172.31.20.251:47148, 172.31.29.87:8182, HTTP_GET, [unknown], [unknown], \"HttpObjectAggregator$AggregatedFullHttpRequest(decodeResult: success, version: HTTP/1.1, content: CompositeByteBuf(ridx: 0, widx: 0, cap: 0, components=0)) GET /status HTTP/1.1 Host: database2-neptune.cluster-xxxxxxxxxxxx.ap-south-1.neptune.amazonaws.com:8182 Accept-Encoding: identity User-Agent: python-urllib3/1.26.5 content-length: 0\", /status";

	// for sparql log data.
	public static final String LOG_MESSAGE1 = "1629182102678, 172.31.20.251:47148, ip-172-31-29-87.ap-south-1.compute.internal/172.31.29.87:8182, HTTP_POST, [unknown], [unknown], \"HttpObjectAggregator$AggregatedFullHttpRequest(decodeResult: success, version: HTTP/1.1, content: CompositeByteBuf(ridx: 0, widx: 68, cap: 68, components=1)) POST /sparql HTTP/1.1 Host: database2-neptune.cluster-xxxxxxxxxxxx.ap-south-1.neptune.amazonaws.com:8182 Accept-Encoding: identity Accept: application/sparql-results+json content-type: application/x-www-form-urlencoded Content-Length: 68 User-Agent: python-urllib3/1.26.5\", query=%0ASELECT+%2A+WHERE+%7B%0A++++%3Fs+%3Fp+%3Fo%0A%7D+LIMIT+10%0A";
	...
	public static final String HTTP_HEADERS = "HttpObjectAggregator$AggregatedFullHttpRequest(decodeResult: success, version: HTTP/1.1, content: CompositeByteBuf(ridx: 0, widx: 0, cap: 0, components=0)) GET /status HTTP/1.1 Host: database2-neptune.cluster-xxxxxxxxxxxx.ap-south-1.neptune.amazonaws.com:8182 Accept-Encoding: identity User-Agent: python-urllib3/1.26.5 content-length: 0\\\", /status";

	public static final String PAYLOAD_KEY = "payload";
	public static final String PAYLOAD = "/status";
	
	public static final String CALLERIAM_KEY = "callerIAM";
	public static final String CALLERIAM = "arn:aws:iam::979326520502:user/***REMOVED***ndeep-verma@hcl.com";

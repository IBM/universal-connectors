...
#### Procedure
 ...
 3. Click Upload File and select the offline [logstash-filter-neptune_guardium_filter.zip](./logstash-filter-neptune_guardium_filter.zip) plug-in. After it is uploaded, click OK. 

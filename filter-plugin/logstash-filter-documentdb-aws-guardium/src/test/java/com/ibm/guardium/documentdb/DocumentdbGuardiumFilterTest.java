...
public class DocumentdbGuardiumFilterTest {
	...
	public void testDbProtocol() {
		final String DbString = "{\"atype\":\"authenticate\",\"ts\":1642760998400,\"remote_ip\":\"172.31.45.103:40528\",\"user\":\"\",\"param\":{\"user\":\"kirtimalhotra\",\"mechanism\":\"SCRAM-SHA-1\",\"success\":true,\"mes***REMOVED***ge\":\"\",\"error\":0}}";
		DocumentdbGuardiumFilter filter = getGuardiumFilterConnector(DbString);
		Event e = new org.logstash.Event();
		TestMatchListener matchListener = new TestMatchListener();
		e.setField("mes***REMOVED***ge", DbString);

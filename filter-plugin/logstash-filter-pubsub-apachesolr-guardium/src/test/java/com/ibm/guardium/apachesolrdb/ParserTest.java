...
public class ParserTest {
	...
	public void testParseQtpConstruct_Find() throws Exception {
		final String solrString = "{\"insertId\":\"epzzqmg1c6dwlg\",\"jsonPayload\":{\"mes***REMOVED***ge\":\"2022-02-10 12:44:20.243 INFO  (qtp672313607-18) [   x:first_core] o.a.s.c.S.Request [first_core]  webapp=\\/solr path=\\/select params={q=id:7698&_=1644497065596} hits=1 status=0 QTime=1\"},\"resource\":{\"type\":\"gce_instance\",\"labels\":{\"project_id\":\"project-sccd\",\"instance_id\":\"2639899388249855782\",\"zone\":\"asia-south2-a\"}},\"timestamp\":\"2022-02-10T12:44:20.244030006Z\",\"logName\":\"projects\\/project-sccd\\/logs\\/files\",\"receiveTimestamp\":\"2022-02-10T12:44:20.439608402Z\"}";
		final JsonObject solrJson = JsonParser.parseString(solrString).getAsJsonObject();
		Record record = Parser.parseQtpRecord(solrJson);

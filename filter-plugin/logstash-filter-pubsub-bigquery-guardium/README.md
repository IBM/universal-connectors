...
1. For the Guardium 11.x, download the [Logstash_Offline_package_7.x](./guardium_logstash-offline-plugins-ps-bigQuery.zip)
2. For the Guardium 12.x, download the [Logstash_Offline_package_8.x](./logstash-filter-big_query_guardium_filter.zip)

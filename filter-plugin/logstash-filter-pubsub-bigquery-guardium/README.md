...
4. Create a table - Expand the: View actions option and click `Open`. - In the details panel, click on (+) Create table. - On the Create table page, do the following:
   Enter Table Name. e.g., “user”.
   You can add more fields to the table by clicking `+Add Field`. - Click `Create Table`.

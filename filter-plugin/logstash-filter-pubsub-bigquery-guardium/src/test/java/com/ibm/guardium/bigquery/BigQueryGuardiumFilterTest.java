...
public class BigQueryGuardiumFilterTest {
	...
	public void filterSQLWithSlashTest() {
		...
		assertEquals("select * from  `project-sccd.BigQueryQADS.empDetails` where name = \"***REMOVED***ndeep \"   ", sqlquery.getData().getConstruct().fullSql);

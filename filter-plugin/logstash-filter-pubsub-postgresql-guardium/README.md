...
### Prerequisites
Download the [Logstash Offline package](https://github.com/IBM/universal-connectors/releases/download/v1.5.0/logstash-filter-pubsub-postgresql-guardium.zip) that includes both the Logstash Google PubSub input plugin and the PostgreSQL PubSub filter plugin, and upload it to the gmachine.
#### Note
...
## Installation
To install this plug-in, you need to download the [offline pack](https://github.com/IBM/universal-connectors/releases/download/v1.5.0/logstash-filter-pubsub-postgresql-guardium.zip) and upload the file to the gmachine

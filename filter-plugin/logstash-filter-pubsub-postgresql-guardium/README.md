...
1. Login to the instance with `gcloud` in _SQL Instance > connect using Cloud Shell_ (password of admin user "postgres" is defined upon instance creation)
2. _SQL Instances > Select & Edit instance >_ add the following flags:

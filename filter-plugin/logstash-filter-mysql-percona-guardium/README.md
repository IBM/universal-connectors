...
4. Click **Upload File** and select the offline [mysql-percona-offline-plugin.zip](https://github.com/IBM/universal-connectors/releases/download/v1.6.0/logstash-filter-mysql_percona_filter.zip) file. After it is uploaded, click OK.

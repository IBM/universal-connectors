...
3. Click **Upload File** and select the downloaded .jar jdbc driver file. After it is uploaded, click **OK**.
   4. Click **Upload File** and select the offline [logstash-offline-plugins-7.12.1.zip](https://github.com/IBM/universal-connectors/releases/download/v1.6.0/logstash-filter-guardium_snowflake_filter.zip)

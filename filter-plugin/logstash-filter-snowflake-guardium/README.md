...
2. Issue the following commands:
   ...
   **NOTE**
   ...
   ````
3. `skip_logging_audit_query` - setting the value of this field to `"false"` will stop capturing the particular
   `select` query that fetches the query logs.
4. `skip_logging_auth_audit_query` - setting the value of this field to `"false"` will stop capturing the particular
...
4. The plugin is tested with Snowflake JDBC driver v3.13.30 and v3.16.0.

# AWS SQS Input Plugin

## Overview
* Version: 1.0.0
* Supported Guardium versions: 12.0 and above
...
This implementation prevents pipeline crashes due to credential or network errors through graceful error handling.

...
//
package com.ibm.guardium.univer***REMOVED***lconnector.commons.structures;

/**
 * A standard Guardium object, required while developing a plug-in for Guardium Univer***REMOVED***l
